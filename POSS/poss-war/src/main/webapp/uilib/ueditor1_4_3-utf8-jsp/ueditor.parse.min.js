            ...
            var d = function (a, c) {
                ...
                var r = {
                    reversecurrent: function (a, b) {
                        ...
                        var d = a[f.isIE ? "innerText" : "textContent"].match(/\d+/), c = b[f.isIE ? "innerText" : "textContent"].match(/\d+/);
                        d && (d = +d[0]);
                        c && (c = +c[0]);
                        return (c || 0) - (d || 0)
                    }
    ...
    UE.parse.register("vedio", function (f) {
        ...
        if (h.length || g.length) {
            var h = f.removeLastbs(this.rootPath),
                g = h + "/third-party/video-js/video.js", a = h + "/third-party/video-js/video-js.min.css", d = h + "/third-party/video-js/video-js.swf";
