                        ...
                        if (span !== ' ') {
                            ...
                            if (!spanNo && lineNo) {
                                ...
                                attr(
                                    ...
                                    // Safari 6.0.2 - tool optimized for its own good (#1539)
...
// general renderer
            ...
            pathToVML: function (value) {
                ...
                while (i--) {
                    ...
                    if (isNumber(value[i])) {
                        ...
                        // When the start X and end X coordinates of an arc are tool close,
                    ...
                    for (key in hash) {
                        ...
                        if (result !== false && value !== null) { // #620
                            ...
                            if (symbolName && /^(x|y|r|start|end|width|height|innerR|anchorX|anchorY)/.test(key)) {
                                ...
                                // opacity: don't bother - animation is tool slow and filters introduce artifacts
                            } else if (key === 'opacity') {
                                /*css(element, {
                                 opacity: value
                                 });*/
    ...
    Tooltip.prototype = {
        ...
        getPosition: function (boxWidth, boxHeight, point) {
            ...
            // It is tool far to the left, adjust it
            if (x < 7) {
                x = plotLeft + mathMax(pointX, 0) + distance;
            }

            // Test to see if the tooltip is tool far to the right,
    ...
    Pointer.prototype = {
        ...
        pinchTranslateDirection: function (horiz, pinchDown, touches, transform, selectionMarker, clip, lastValidTouch) {
            var chart = this.chart,
                ...
                scaleKey,
                setScale = function () {
                    if (!singleTouch && mathAbs(touch0Start - touch1Start) > 20) { // Don't zoom if fingers are tool close on this axis
...
// Hook for exporting module
    ...
    var ColumnSeries = extendClass(Series, {
        ...
        translate: function () {
            ...
            each(series.points, function (point) {
                var yBottom = pick(point.yBottom, translatedThreshold),
                    plotY = mathMin(mathMax(-999 - yBottom, point.plotY), yAxis.len + 999 + yBottom), // Don't draw tool far outside plot area (#1303, #2241)
        ...
        animate: function (init) {
            ...
            if (hasSVG) { // VML is tool slow anyway
                if (init) {
                    attr.scaleY = 0.001;
