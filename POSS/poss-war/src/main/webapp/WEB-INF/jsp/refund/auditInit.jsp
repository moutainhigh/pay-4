...
<!-- <table width="25%" border="0" cellspacing="0" cellpadding="0"
	...
	<tr>
		<td height="18">
		<div align="center"><font class="titletext">充退查询
</font></div>
		</td>
	</tr>
	<tr>
  ...
  <table class="border_all2" width="80%" border="0" cellspacing="0"
    ...
    <tr class="trForContent1">
  	...
  	<tr class="trForContent1">
      	...
      	<td class=border_top_right4 align="right" >银行渠道：<!-- 交易状态： --></td>
      	<td class="border_top_right4" >
...
<script type="text/javascript">
	...
	function submitByHref(pageNo,totalCount,pageSize) {
		...
		var pars = $("#mainfromId").serialize() + "&pageNo=" + pageNo + "&totalCount=" + totalCount + "&pageSize=" + pageSize;
			$.ajax({
				type: "POST",
				url: "refund.manage.do?method=queryRefundList",
				data: pars,
	...
	function downloadAuditInfo(){
		document.mainfrom.action = "refund.manage.download.do?method=handleDownloadAuditInfo";
