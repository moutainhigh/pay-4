...
function indexQuery(pageNo,totalCount,pageSize) {
	...
	$.ajax({
		type: "POST",
		url: "${ctx}/if_poss/accoFeeFailed.do?method=search",
		data: pars,
...
$(function(){
	...
	$("#beginDate").focus(function (){
		...
		WdatePicker({onpicked:function(){endDate.focus();},dateFmt:'yyyy-MM-dd HH:mm:ss',minDate:'#F{$dp.$D(\'endDate\',{M:-3})}',maxDate:startMax});
	});
	$("#endDate").focus(function (){
		...
		WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd HH:mm:ss',minDate:endMin,"maxDate":maxDate});
	});
...
<table width="35%" border="0" cellspacing="0" cellpadding="0"
	...
	<tr>
		<td height="18">
		<div align="center"><font class="titletext">计费策略扣费失败查询</font></div>
		</td>
	</tr>
	<tr>
		<td height="1" bgcolor="#000000"></td>
	...
	<form id="searchFormBean" style="width: 100%;text-align: center">
		<table class="searchTermTable" class="inputTable" style="width:60%;margin: 0px auto" >
			<tr>
				<th style="text-align: right">起止时间：</th>
			...
			<tr>
				...
				<td style="text-align: left" colspan="3"><input type="text" id="acctName" name="acctName"  title="账户名称" style="width: 150px;" maxlength="32" />
				支付服务名称：
				<input type="text" id="serviceName" name="serviceName"  title="支付服务名称" style="width: 150px;" maxlength="32" />
			</td>
			</tr>
