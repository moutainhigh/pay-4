			...
			if(res==true){
				...
				if(sel.value=="")
					...
					var pars = $("#userSearchForm").serialize() + "&pageNo=" + pageNo + "&totalCount=" + totalCount + "&pageSize=" + pageSize +
								"&userId="+userId +"&wkKey="+wkKey;
					$.ajax({
						type: "POST",
						url: "${ctx}/withdrawAllocate.do?method=transmitTask",
						data: pars,
	...
	<table id="userTable" class="tablesorter" border="0" cellpadding="0" cellspacing="1">
		...
		<tbody>
			...
			<tr>     
				...
				<td><a href="${ctx}/withdrawAllocate.do?method=showAuditOrderDetail&orderId=${orderDto.sequenceId}&workFlowId=${orderDto.workflowKy}&nodeId=2">查看</a></td>
			</tr>
			</c:forEach>
		</tbody> 
	</table>
	...
	<table align="center">
		...
		<tr>
			<td align="center" colspan="2">
				<input type="button" onclick="transmitTask();" name="submitBtn" value="转    派" class="button4">	
			</td>
		</tr>
	</table>
</body>
