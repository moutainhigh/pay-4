	...
	<head>
		...
		<script type="text/javascript">
			...
			function withdrawQuery(pageNo,totalCount,pageSize) {
				...
				$.ajax({
					type: "POST",
					url: "${ctx}/withdrawSecondAudit.do?method=search",
					data: pars,
			...
			function downLoad(){
				...
				document.userSearchForm.action = "withdrawSecondAuditDownload.do?method=exportExcel";
	...
	<body>
		<!-- <table width="25%" border="0" cellspacing="0" cellpadding="0" align="center" height="21">
			...
			<tr>
				<td height="18">
					<div align="center">
						<font class="titletext">查询待复核数据</font>
					</div>
				</td>
			</tr>
			<tr>
		...
		<h2 class="panel_title">查询待复核数据</h2>
