...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			function withdrawQuery(pageNo,totalCount,pageSize) {
				...
				$.ajax({
					type: "POST",
					url: "${ctx}/withdrawreport.htm?method=queryDisposedData",
					data: pars,
			...
			function downloadAuditInfo(){
				document.userSearchForm.action = "withdrawreportDownload.htm?method=downloadDisposedData";
				document.userSearchForm.submit();
			}
		</script>
	</head>
	...
	<body>
		<h2 class="panel_title">查询风控已处理数据</h2>
		<form id="userSearchForm" name="userSearchForm" method="post" action="">
		<table class="border_all2" width="80%" border="0" cellspacing="0" cellpadding="1" align="center">
			<tr class="trForContent1">
				<td class="border_top_right4" align="right" >风控处理时间：</td>
			...
			<tr class="trForContent1">
				<td class="border_top_right4" align="right" >审核员：</td>
				<td class="border_top_right4">
					<input type="text" name="auditUser" style="width: 150px;" />
				</td>
				<td class="border_top_right4" align="right" >复核员：</td>
			    <td class="border_top_right4">
	        		<input type="text" name="reAuditUser" style="width: 150px;" />
				</td>
			</tr>
			<tr class="trForContent1">
			...
			<tr class="trForContent1">
				...
				<td class="border_top_right4">
					<select name="businessStatus" style="width: 150px;">
						<option value="">全部</option>
						<option value='3'>&nbsp;&nbsp;审核滞留&nbsp;&nbsp;</option>
						<option value='1'>审核通过</option>
						<option value='2'>审核拒绝</option>
						<option value='4,7,11,12'>复核通过</option>
						<option value='5,10'>复核拒绝</option>
					</select>
				</td>
				<td class="border_top_right4" align="right" >清结算是否废除：</td>
				<td class="border_top_right4">
					<select name="liquidateFlag" style="width: 150px;">
						<option value='0,1' checked>&nbsp;&nbsp;否&nbsp;&nbsp;</option>
			...
			<tr class="trForContent1">
				<td class="border_top_right4" align="center" colspan="4">
					...
					<input type="button" name="btnDownload" class="button2" value="下载" onclick="downloadAuditInfo();"/>
				</td>
			</tr>
		</table>
		</form>
