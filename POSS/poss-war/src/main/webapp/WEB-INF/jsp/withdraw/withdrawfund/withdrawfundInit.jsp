	...
	<title>出款退款申请</title>
		<script type="text/javascript">
			...
			function query(pageNo,totalCount,pageSize) {
				...
				$.ajax({
					type: "POST",
					url: "${ctx}/fundout-withdraw-withdrawrefund.do?method=search",
					data: pars,
			...
			function checkInfo(){
				...
				if($.trim(seqId).length>0 && !reg.test(seqId)){
					alert("交易流水必须为数字");
					return false;
				}
				return true;
		...
		<table class="border_all2" width="80%" border="0" cellspacing="0" cellpadding="1" align="center">
			<tr class="trForContent1">
				<td align="right" class="border_top_right4" class="textRight"> 交易流水号：</td>
			   	<td class="border_top_right4" class="textLeft"><input type="text" id ="sequenceId"   name="sequenceId" style="width: 150px;" /></td>
	   			<td align="right" class="border_top_right4" class="textRight"> 交易时间：</td>
			   	<td class="border_top_right4" class="textLeft"><input type="text" id ="createTime"   name="createTime"  style="width: 150px;" 
		   ...
		   <tr class="trForContent1">
	   			...
	   			<td align="right" class="border_top_right4" class="textRight"> 银行账户：</td>
			   	<td class="border_top_right4" class="textLeft"><input type="text" id ="bankAcct"   name="bankAcct" style="width: 150px;" /></td>	
		   	</tr>
		   	<tr class="trForContent1">
		   		<td align="right" class="border_top_right4" class="textRight"> 银行流水号：</td>
			   	<td class="border_top_right4" class="textLeft">
		   	...
		   	<tr class="trForContent1">
		   		<td class="border_top_right4" colspan="4" align="center">
                	<input calss="button2" type="button" id="btn" value="查询"/>
                </td>
		   	</tr>
		</table>
		</form>
