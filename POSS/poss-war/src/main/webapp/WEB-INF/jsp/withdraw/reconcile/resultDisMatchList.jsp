...
<table id="userTable" class="tablesorter" border="0" cellpadding="0" cellspacing="1">
	<thead> 
		<tr>     
				...
				<th><font color="red"> 银行状态</font></th>
				<th>原因</th>
			</tr> 
	...
	<c:forEach items="${page.result}" var="dto" varStatus="status">
		<c:choose>
	       ...
	       <c:otherwise>
			...
			<!--<td >
				<li:select name="" showStyle="desc" itemList="${statusList}" selected="${dto.busiFlag }"/>
			</td>
			...
			<td ><font color="red">
			<li:select name="" showStyle="desc" itemList="${bankStatusList}" selected="${dto.leftStatus }"/>
			</font></td>
