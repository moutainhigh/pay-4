...
<span style="padding-left:10px; font-size: 15px; "><img src="hnastyle/images/CategorizeMenu.png" style="vertical-align:text-bottom;padding-top:2px;" width="20" height="20" align="absmiddle" />POSS后台管理系统</span>