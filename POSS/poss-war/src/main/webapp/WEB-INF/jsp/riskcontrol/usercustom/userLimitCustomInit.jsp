...
<head>
	<script type="text/javascript">
		function searchBusinessLimitCustom(pageNo,totalCount,pageSize) {
			...
			$.ajax({
				type: "POST",
				url: "${ctx}/rm_limit_userlimitcustom.htm?method=searchBusinessLimitCustoms",
				data: pars,
...
<!-- 	<table width="25%" border="0" cellspacing="0" cellpadding="0" align="center" height="21">
		...
		<tr>
			<td height="18">
				<div align="center">
					<font class="titletext">用户定制限额查询</font>
				</div>
			</td>
		</tr>
		<tr>
		...
		<h2 class="panel_title">用户定制限额查询</h2>
    <form id="searchForm">
	<table class="border_all2" width="80%" border="0" cellspacing="0" cellpadding="1" align="center">
		...
		<tr class="trForContent1">
			<td colspan="6" align="center" class="border_top_right4">
	      		<input type="button" onclick="searchBusinessLimitCustom();" name="submitBtn" value="查  询" class="button2">
	      	</td>
		</tr>
	</table>
    </form>
