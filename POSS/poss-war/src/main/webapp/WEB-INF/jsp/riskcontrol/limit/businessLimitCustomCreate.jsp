...
<body>
	<!-- <table width="25%" border="0" cellspacing="0" cellpadding="0" align="center" height="21">
		...
		<tr>
			<td height="18">
				<div align="center">
					<font class="titletext">新增商户定制限额</font>
				</div>
			</td>
		</tr>
		<tr>
	...
	<h2 class="panel_title">新增商户定制限额</h2>
	
	<form method="post" action="${ctx}/rm_limit_businesslimitcustom.htm?method=businessLimitCustomCreate">
	<table class="border_all2" width="75%" border="0" cellspacing="0" cellpadding="3" align="center">
		<tr class="trForContent1">
			...
			<td class="border_top_right4">
				<input type="text" name="businessId" id="businessId" maxlength="19"/>
			</td>
