...
<!--
	$(function(){
		$("#backBtn").click(function(){
			window.location = "${ctx}/rm-blackandwhite-whitelist.htm";
		});
...
<table width="25%" border="0" cellspacing="0" cellpadding="0"
	...
	<tr>
		<td height="18">
		<div align="center"><font class="titletext">添加白名单</font></div>
		</td>
	</tr>
	<tr>
		<td height="1" bgcolor="#000000"></td>
...
<form action="rm-blackandwhite-whitelist.htm?method=whitelistCreate" method="post" id="whiteListAddSave">
