...
<h2 class="panel_title">商户基本汇率导入</h2>
<form action="${ctx}/settlementBaseRate/rate.do?method=add" method="post" id="mainfromId" enctype="multipart/form-data" onsubmit="return sub();">
...
<c:if test="${not empty messageCode}">
  ...
  function download(){
		window.location.href='${ctx}/settlementBaseRate/rate.do?method=downloadTemplate';
	}
  
	function toIndex(){
		window.location.href="${ctx}/settlementBaseRate/rate.do";
	}
