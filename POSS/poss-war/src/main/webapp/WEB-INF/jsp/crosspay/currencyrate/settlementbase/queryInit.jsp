...
<h2 class="panel_title">结算基本汇率管理</h2>
...
<script type="text/javascript">
	...
	function toAdd(){
		window.location.href="${ctx}/settlementBaseRate/rate.do?method=toAdd";
	}
	...
	function search(pageNo,totalCount,pageSize) {
		...
		$.ajax({
			type: "POST",
			url: "${ctx}/settlementBaseRate/rate.do?method=list&pageNo=" + pageNo,
			data: pars,
