...
<h2 class="panel_title">商户交易汇率微调管理</h2>
...
<script type="text/javascript">
	...
	function toAdd(){
		window.location.href="${ctx}/transactionRateAdjust/adjust.do?method=toAdd";
	}
	...
	function search(pageNo,totalCount,pageSize) {
		...
		$.ajax({
			type: "POST",
			url: "${ctx}/transactionRateAdjust/adjust.do?method=list",
			data: pars,
