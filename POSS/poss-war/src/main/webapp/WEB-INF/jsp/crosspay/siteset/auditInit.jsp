...
<form action="" method="post" id="mainfromId">
			<input type="hidden" name="statusIn" value="${map.statusIn}">
...
<script type="text/javascript">
	...
	function toAudit(id,partnerId,url,status){
		window.location.href="${ctx}/crosspay/sitesetAudit.do?method=toAudit&id="+id+"&partnerId="+partnerId+"&siteId="+url+"&status="+status;
	}
	...
	function del(id) {
		...
		$.ajax({
			type: "POST",
			url: "${ctx}/crosspay/sitesetAudit.do?method=del&id="+id,
			data: pars,
