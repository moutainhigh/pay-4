...
<h2 class="panel_title">商户汇率导入</h2>
<form action="${ctx}/partnerCurrency/rate.do?method=add" method="post" id="mainfromId" enctype="multipart/form-data" onsubmit="return sub();">
	<table class="border_all2" width="90%" border="0" cellspacing="0"
		cellpadding="1" align="center">	
	    <tr class="trForContent1">
	    <td align="right" class="border_top_right4" >会员号：</td>
	      <td class="border_top_right4">
	      	<input name="partnerId" id="partnerId" value=""/>
	      </td>
...
<c:if test="${not empty messageCode}">
  ...
  <script type="text/javascript">
	...
	function download(){
		window.location.href='${ctx}/partnerCurrency/rate.do?method=downloadTemplate';
	}
  
	function toIndex(){
		window.location.href="${ctx}/partnerCurrency/rate.do";
	}
