...
function moveOptions() { 
	...
	function checkForm() {
		...
		select_all();
		var url="${ctx}/paymentChannelItemNew.htm?method=setItemUpdate";
...
<table class="border_all2" width="60%" border="0" cellspacing="0" cellpadding="1" align="center">
	<form id="testjop1" action="${ctx}/paymentChannelItemNew.htm?method=setItemUpdate" method="post">
	<input name="paymentChannelNewId" type="hidden" value="${paymentChannelNewId}" />
	<tr valign="top" class="trForContent1">
		...
		<table width="617" border="0" cellspacing="0" cellpadding="0">
			...
			<tr align="center">
				<td align="left">可配置的通道</td>
				<td>&nbsp;</td>
				<td align="left">已配置的通道</td>
			</tr>
			<tr align="center">
				...
				<td width="192" align="left">
						...
						<c:forEach items="${alllist}" var="ke">
							<option value="${ke.id}">${ke.itemName}</option>
						</c:forEach>
					</select>
				</td>
				<td width="121">
