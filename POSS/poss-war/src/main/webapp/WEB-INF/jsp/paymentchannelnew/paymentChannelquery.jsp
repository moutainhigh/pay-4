...
function query() {
	...
	$.ajax({
		type: "POST",
		url: "${ctx}/paymentchannelconfig.htm?method=search",
		data: pars,
...
<table width="25%" border="0" cellspacing="0" cellpadding="0"
	...
	<tr>
		<td height="18">
		<div align="center"><font class="titletext"> 支 付 渠 道 管 理 </font></div>
		</td>
	</tr>
	<tr>
		<td height="1" bgcolor="#000000"></td>
	...
	<table class="border_all2" width="95%" border="0" cellspacing="0"
		cellpadding="1" align="center">		
			<tr class="trForContent1">
				<td class="border_top_right4" align="right" >支付渠道名称：</td>
				<td class="border_top_right4" align="left" >
					<input type="text" id="name" name="name" value="">
				</td>	
				<td class="border_top_right4" align="right" >支付渠道code：</td>
				<td class="border_top_right4" align="left" >
