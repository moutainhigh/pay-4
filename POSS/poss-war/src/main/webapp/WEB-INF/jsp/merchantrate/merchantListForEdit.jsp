...
function merchantQuery(pageNo,totalCount,pageSize) {
	...
	$.ajax({
		type: "POST",
		url: "${ctx}/merchantRate.do?method=merchantList",
		data: pars,
...
function validFrom() {
    ...
    if(null != memberCode && memberCode != ''){
    	 var isMemberCodeNum = reg.test(memberCode.replace(/(^\s*)|(\s*$)/g, ""));
    	 if(!isMemberCodeNum){
    		 alert('会员号输入不合法');
        	 return;
    	 }
...
<table class="border_all2" width="95%" border="0" cellspacing="0"
	...
	<tr class="trForContent1">
		...
		<td class="border_top_right4" align="left" ><input type="text" id="merchantUrl" name="merchantUrl"></td>
	</tr>
	<tr class="trForContent1">
		<td class="border_top_right4" colspan="6" align="center">
			<a class="s03" href="javascript:validFrom()"><input class="button2" type="button" value="查询"></a>
		</td>
	</tr>
