...
<table class="tablesorter" width="100%" align="center" border="0" cellpadding="0" cellspacing="1">
	...
	<c:choose>
	       ...
	       <c:otherwise>
			...
			<td class="" align="center" ><a href="javascript:forCheck('/merchantRate.do?method=merchantEdit&memberCode=${merchant.memberCode}');">${merchant.merchantCode}</a></td>
