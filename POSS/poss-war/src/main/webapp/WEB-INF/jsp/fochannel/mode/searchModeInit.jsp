...
<table width="25%" border="0" cellspacing="0" cellpadding="0"
	...
	<tr>
		<td height="18">
		<div align="center"><font class="titletext">查询出款方式</font></div>
		</td>
	</tr>
	<tr>
		<td height="1" bgcolor="#000000"></td>
 ...
 <form action="" method="post" id="mainfromId">
		<table class="border_all2" width="80%" border="0" cellspacing="0"
		    ...
		    <tr class="trForContent1">
		      ...
		      <input style="width: 100px;" type="button" value="添加出款方式" id="btn_add" onClick="add()"/>
  ...
  <script type="text/javascript">
	...
	function search(pageNo,totalCount,pageSize) {
		...
		;
			$.ajax({
				type: "POST",
				url: "context_fundout_fomode.controller.htm?method=search",
				data: pars,
	...
	function add(){
		window.location.href='${ctx}/context_fundout_fomode.controller.htm';
	}
