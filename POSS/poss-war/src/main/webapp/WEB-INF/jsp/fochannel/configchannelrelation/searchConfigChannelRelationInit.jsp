...
<h2 class="panel_title">查询出款产品与出款渠道配置</h2>
  ...
  <script type="text/javascript">
	...
	function searchConfig(pageNo,totalCount,pageSize) {
		...
		;
			$.ajax({
				type: "POST",
				url: "context_fundout_configchannelrelation.controller.htm?method=search",
				data: pars,
	...
	function addConfig(){
		window.location.href="${ctx}/context_fundout_configchannelrelation.controller.htm";
	}	
  </script>