...
<table width="25%" border="0" cellspacing="0" cellpadding="0"
	...
	<tr>
		<td height="18">
		<div align="center"><font class="titletext">修改出款银行</font></div>
		</td>
	</tr>
	<tr>
		<td height="1" bgcolor="#000000"></td>
...
<form action="context_fundout_fobank.controller.htm?method=modifyFundoutBankInfo" method="post" name="mainfrom">
	<input name="bankId" type="hidden" value="${dto.bankId }" />
 ...
 <script type="text/javascript">
	...
	function goBack() {
		document.mainfrom.action="context_fundout_fobank.controller.htm?method=initSearch";
