...
<table id="sorterTable" class="tablesorter" border="0" cellpadding="0" cellspacing="1">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<input type="button" onclick="searchBusinessForId('${dto.businessId}');"  id="submitBtn" class="button2" value="修 改">
						</td>
					</c:forEach>
 ...
 <script type="text/javascript">
	...
	function searchBusinessForId(businessId){
		document.listFrom.action="context_fundout_fobusiness.controller.htm?method=initModify&businessId="+businessId;
