...
<form action="context_fundout_fobusiness.controller.htm?method=modifyFundoutBusinessInfo" method="post" name="mainfrom">
	<input name="businessId" type="hidden" value="${dto.businessId }" />
	 <table class="border_all2" width="80%" border="0" cellspacing="0"
		cellpadding="1" align="center">	
	    <tr class="trForContent1">
	      <td align="right" class="border_top_right4" >业务Code：</td>
 ...
 <script type="text/javascript">
	...
	function goBack() {
		document.mainfrom.action="context_fundout_fobusiness.controller.htm?method=initSearch";
