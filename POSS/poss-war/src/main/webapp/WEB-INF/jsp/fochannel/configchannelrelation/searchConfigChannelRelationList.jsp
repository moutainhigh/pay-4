...
<table id="sorterTable" class="tablesorter" border="0" cellpadding="0" cellspacing="1">
	       ...
	       <c:otherwise>
	             <tr class="trForContent2">
						...
						<td>
							<li:codetable fieldName="productCode" selectedValue="${dto.productCode}" style="desc" attachOption="true" codeTableId="fundOutProductTable" />
						</td>
						<td>
						...
						<td>
							<input type="button" onclick="modify('${dto.configId}');"  id="submitBtn" class="button2" value="修改">
 ...
 <script type="text/javascript">
	...
	function modify(configId){
		document.listFrom.action="context_fundout_configchannelrelation.controller.htm?method=initModify&configId="+configId;
		document.listFrom.submit();
	}

	function del(configId){
		if(confirm('确认删除吗？')){
			document.listFrom.action="context_fundout_configchannelrelation.controller.htm?method=del&configId="+configId;
			document.listFrom.submit();
			}
	}
