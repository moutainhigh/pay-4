...
<script type="text/javascript">
	...
	function downLoad(){
		var pars = $("#form1").serialize();
		window.location.href = '${ctx}/tradeFailDeal.do?method=download&'+pars
	}
</script>
</head>

<body>
<h2 class="panel_title">交易失败详细分析</h2>
  ...
  <table class="border_all2" width="80%" border="0" cellspacing="0"
    ...
    <tr class="trForContent1">
	      ...
	      <td align="right" class="border_top_right4">交易日期：</td>
	      	<td class="border_top_right4">
		      	<input class="Wdate" type="text" id="startDate" name="startTime" value="${dateStr}"  onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})">
		        	～
				<input class="Wdate" type="text" id="endDate" name="endTime"  value="${dateStr}" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})">
	      	</td>
	      ...
	      <td align="right" class="border_top_right4" >返回码所属：</td>
	      <td class="border_top_right4">
	      	   	<select name="target" id="target" style="width: 137px;height: 20px">
	     				<option value='T'>商户</option>
	     				<option value='C'>收单行</option>
	     		</select>
	      </td>
    </tr>
    <tr class="trForContent1">
