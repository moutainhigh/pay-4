...
<body>
	...
	<thead>
	  <tr class="tabT">
	    ...
	    <th class="tabTitle" scope="col">批次号</th>
	    <th class="tabTitle" scope="col">付款方会员号</th>
	    <th class="tabTitle" scope="col">收款银行名称</th>
	    <th class="tabTitle" scope="col">银行账号</th>
	    <th class="tabTitle" scope="col">开户行所在省份</th>
	    <th class="tabTitle" scope="col">开户行所在城市</th>
	    <th class="tabTitle" scope="col">收款方名称</th>
	    <th class="tabTitle" scope="col">交易金额</th>
	  ...
	  <tr>
	    ...
	    <td>&nbsp;${dto.sequenceId}</td>
	     ...
	     <td>&nbsp;${dto.bankName}</td>
	     <td>&nbsp; ${dto.bankAcct} </td>
	     <td>&nbsp; ${dto.payeeBankProvinceName} </td>
	     <td>&nbsp; ${dto.payeeBankCityName} </td>
	     <td>&nbsp; ${dto.payeeName} </td>
