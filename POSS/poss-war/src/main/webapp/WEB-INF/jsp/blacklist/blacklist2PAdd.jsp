...
<table width="25%" border="0" cellspacing="0" cellpadding="0" align="center" height="21">
	...
	<tr>
		<td height="18">
		<div align="center"><font class="titletext">新增个人名单信息</font></div>
		</td>
	</tr>
	<tr>
		<td height="1" bgcolor="#000000"></td>
...
<form method="post" id="form1" action="${ctx}/blacklist.do?method=addBlacklist2P" >
<table class="inputTable" width="800" border="0" cellspacing="0" cellpadding="3" align="center">
	    ...
	    <tr>
	    	<td align="right" >负面信息备注:</td>
	      	<td colspan="3">
	      		<textarea rows="4" cols="100" name="hmdsjbz" id="hmdsjbz" maxlength="100"></textarea>
	     	</td>
	    </tr>
</table>
<br>
