...
<script type="text/javascript">
	function processBack(){
		location.href = "${ctx}/blacklist.do?method=blacklist2EInit";
	}
...
<table width="25%" border="0" cellspacing="0" cellpadding="0" align="center" height="21">
	...
	<tr>
		<td height="18">
		<div align="center"><font class="titletext">修改机构名单信息</font></div>
		</td>
	</tr>
	<tr>
		<td height="1" bgcolor="#000000"></td>
...
<form method="post" action="${ctx}/blacklist.do?method=updateBlacklist2E" id="form1">
