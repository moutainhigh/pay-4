...
<form action="" method="post" id="mainfromId">
	<table class="border_all2" width="80%" border="0" cellspacing="0"
	    ...
	    <tr class="trForContent1">
	      <td align="right" class="border_top_right4" >会员CODE：</td>
	      <td class="border_top_right4">
	      	<input type="text" value="" name="merchantCode"/>
	      </td>
	     </tr>
	    <tr class="trForContent1">
	      <td align="center" class="border_top_right4" colspan="2">
	      <input type="button"  name="butSubmit" value="查  询" class="button2" onclick="search();">
	      <input type="button"  name="butSubmit1" value="添  加" class="button2" onclick="javascript:window.location.href='${ctx}/context_withhold_merchant.controller.htm?method=toAdd';">
	      </td>
	    </tr>
   </table>
</form>
  ...
  <script type="text/javascript">
	...
	function search(pageNo,totalCount,pageSize) {
		...
		;
			$.ajax({
				type: "POST",
				url: "context_withhold_merchant.controller.htm?method=query",
				data: pars,
