...
<table width="25%" border="0" cellspacing="0" cellpadding="0"
	...
	<tr>
		<td height="18">
		<div align="center"><font class="titletext">新增商户收款协议</font></div>
		</td>
	</tr>
	<tr>
		<td height="1" bgcolor="#000000"></td>
...
<form action="context_withhold_recieveprotocol.controller.htm?method=add" method="post" name="mainform">
	<li:token formId="addRecieveProtocolForm" />
	...
	<table class="border_all2" width="80%" border="0" cellspacing="0"
	    ...
	    <tr class="trForContent1">
		 ...
		 <tr class="trForContent1">
		      ...
		      <td class="border_top_right4" >
		          <input class="Wdate" type="text" name="effectDate" id="effectDate" value='' 
