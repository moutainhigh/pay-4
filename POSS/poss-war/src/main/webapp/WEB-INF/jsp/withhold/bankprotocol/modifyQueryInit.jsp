...
<table width="25%" border="0" cellspacing="0" cellpadding="0"
	...
	<tr>
		<td height="18">
		<div align="center"><font class="titletext">查询已审核签约银行</font></div>
		</td>
	</tr>
	<tr>
		<td height="1" bgcolor="#000000"></td>
...
<form action="" method="post" id="mainfromId">
	<table class="border_all2" width="80%" border="0" cellspacing="0"
	    ...
	    <tr class="trForContent1">
	      <td align="right" class="border_top_right4" >签约银行：</td>
	      <td class="border_top_right4">
	      	<li:codetable fieldName="bankCode" style="select" attachOption="true" codeTableId="fundOutBankTable"></li:codetable>
	      </td>
	     </tr>
	    <tr class="trForContent1">
  ...
  <script type="text/javascript">
	...
	function search(pageNo,totalCount,pageSize) {
		...
		;
			$.ajax({
				type: "POST",
				url: "context_withhold_bankprotocol.controller.htm?method=queryModifyList",
				data: pars,
