...
<li:pagination methodName="search" pageBean="${page}" sytleName="black2"/>
 <script type="text/javascript">
	...
	function swithStatus(bankProtocolNo,operatType){
		document.listFrom.action="context_withhold_bankprotocol.controller.htm?method=switchStatus&bankProtocolNo="+bankProtocolNo+"&operatType="+operatType;
