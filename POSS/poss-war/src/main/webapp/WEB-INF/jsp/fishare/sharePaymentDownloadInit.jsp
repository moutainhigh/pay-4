...
<table width="25%" border="0" cellspacing="0" cellpadding="0"
	...
	<tr>
		<td height="18">
		<div align="center"><font class="titletext">付款明细对账单</font></div>
		</td>
	</tr>
	<tr>
		<td height="1" bgcolor="#000000"></td>
...
<li:token formId="mainfrom"/>
 ...
 <script type="text/javascript">
	  ...
	  function paymentDownList(){
		...
		document.mainfromId.action="shareDownload.htm?method=sharePaymentDownloadSubmit";
