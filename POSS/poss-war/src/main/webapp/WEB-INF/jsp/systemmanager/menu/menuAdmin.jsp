...
<table class="border_all2" width="60%" border="0" cellspacing="0" cellpadding="1" align="center" style="margin:0 auto;">
	<tr align="center" class=trForContent1>
	...
	<tr valign="top" class="trForContent1">
		...
		<table width="617" border="0" cellspacing="0" cellpadding="0">
			...
			<tr align="center">
				<td align="left">菜单配置根 <input type="button" class="button2" style="font-size:11px " value="全部展开 " onclick="zTree1.expandAll(true);" />
									  <input type="button" class="button2"  style="font-size:11px " value="全部闭合" onclick="zTree1.expandAll(false);" />	
					</td>
				<td>&nbsp;</td>
				<td align="left">编辑菜单区<div style="float: right"><input type="button"  class="button2" style="font-size:11px " name="addBtn" value="添加子菜单"  onclick="editNewSon()" > </div>
									  </td>
			</tr>
			<tr align="center">
				...
				<ul id="treeDemo" class="tree" style="width:300px; height:100%;overflow:auto;border: 1px solid #ccc;"></ul>
				</td>
				<td width="121">
				</td>
				<td width=340px  height="500" align=center valign=top style="width:300px; overflow:auto;">
					...
					<table class="border_all2 inputTable" width="380" border="0" cellspacing="0" cellpadding="3" align="center" >
						...
						<tr class="trbgcolor10">
							<th class="border_top_right4" colspan="2" style="text-align: center">
								<input type="button"  class="button2" name="sbBtn" value="保存"  onclick="formSubmit()" > 
						</th>
						</tr>
					</table>
