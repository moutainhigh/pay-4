...
<h2 class="panel_title"><c:if test="${role == null}">创建</c:if><c:if test="${role != null}">修改</c:if>角色</h2>

<table class="border_all2" width="500" border="0" cellspacing="0" cellpadding="3" align="center" style="margin:0 auto;">
			
				<tr class="trForContent1">
					<td class="border_top_right4" align="right" >角色名:</td>
					<td class="border_top_right4"><input type="text" maxlength="22" id="roleName" name="roleName" size="22" value="${role.roleName}" class="required"/></td>
				</tr>
				<tr class="trForContent1">
					<td class="border_top_right4" align="right">角色说明:</td>
					<td class="border_top_right4"><textArea id="roleRemarks" maxlength="200" name="roleRemarks">${role.roleRemarks}</textArea></td>
				</tr>
				<tr class="trForContent1">
					<td class="border_top_right4" align="right">授权:</td>
					<td class="border_top_right4" width=340px  height="500" align=left valign=top style="width:300px; overflow:auto;color:#333333">
				...
				<tr class="trForContent1">
					<td class="border_top_right4" align="center" colspan="2" >
						<input type="button" class="button2" value="提交" onclick="saveRole();"/>&nbsp;  
