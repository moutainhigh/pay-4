...
<script language="javascript">
	...
	function indexQuery(pageNo, totalCount, pageSize) {
		...
		var pars = $("#searchFormBean").serialize() + "&pageNo=" + pageNo
	...
	function editAuthIp(id) {
		...
		if (id != null) {
			$.getJSON("${ctx}/security/authIp.do?method=getAuthIpJson", {
				"authId" : id
			}, function cbk(obj) {
				$("#ip").val(obj.authIp);
		...
		$('#addLogDiv').dialog({
			...
			buttons : {
			 	'确定' : function() {
					...
					$.post("${ctx}/security/authIp.do", objs, function(msg) {
						if (msg == "S") {
...
<body>
	...
	<!-- <table width="35%" border="0" cellspacing="0" cellpadding="0"
		...
		<tr>
			<td height="18">
				<div align="center">
					<font class="titletext">授 权 I P 管 理</font>
				</div>
			</td>
		</tr>
		<tr>
	...
	<h2 class="panel_title">授权IP管理</h2>

	<form id="searchFormBean">
		<table class="border_all2" width="80%" border="0" cellspacing="0" cellpadding="3" align="center">
			<tr class="trForContent1">
				<td align="right" class="border_top_right4">登录名：</td>
				<td class="border_top_right4"><input type="text" id="loginName" name="loginName"
					style="width: 150px;" maxlength="50" /></td>
				<td align="right" class="border_top_right4">授权IP地址：</td>
				<td class="border_top_right4"><input type="text" id="authIp" name="authIp"
					style="width: 150px;" maxlength="20" /></td>
				<td align="right" class="border_top_right4">限制状态： </td>
				<td class="border_top_right4"><select name="status">
			...
			<tr class="trForContent1">
				<td colspan="6" align="center" class="border_top_right4"><a href="#"
					class="dialog_link ui-state-default ui-corner-all button2"
					onclick="indexQuery()"> <span class="ui-icon ui-icon-search"></span>&nbsp;查&nbsp;&nbsp;询&nbsp;
				</a>&nbsp;&nbsp;&nbsp; <a href="javascript:void(0)"
					onclick="editAuthIp()"
					class="dialog_link ui-state-default ui-corner-all button2"> <span
						class="ui-icon ui-icon-newwin"></span>&nbsp;添加授权IP&nbsp;
				</a></td>
			</tr>
		</table>
	</form>
	...
	<div id="allOverlayDiv" class="ui-widget-overlay"
	...
	<div id="addLogDiv" style="display: none">
		<table class="inputTable" width="400" height="180" border="0"
			...
			<tr>
				<th>所在部名名称</th>
				<td><input type="text" name="authDept" id="authDept" /></td>
			</tr>
			<tr>
				<th><span class="must">*</span>是否有效</th>
				<td><select name="ipStatus" id="ipStatus">
