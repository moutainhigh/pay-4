	...
	<table class="border_all2" width="80%" border="0" cellspacing="0" cellpadding="1" align="center">
		<tr class="trForContent1">
			...
			<td class="border_top_right4" align="center">
				  角色名称: <input type="text" name="roleName" id="roleName" value="${roleName}" size="20" />(输入关键字查询，支持模糊查询)
			</td>
		</tr>
		<tr class="trForContent1">
			<td class="border_top_right4" align="center" colspan="2">
				<a href="#" class="dialog_link ui-state-default ui-corner-all" onclick="roleQuery()" >
						<span class="ui-icon ui-icon-search button2"></span>查询
				</a>&nbsp;&nbsp;&nbsp;
				<a href="${ctx}/roleAdmin.do?method=init&roleKy=" class="dialog_link ui-state-default ui-corner-all">
						<span class="ui-icon ui-icon-newwin button2"></span>添加角色
				</a>
			</td>
		</tr>
	</table>
