...
<br>
<br> -->
<h2 class="panel_title">用户角色管理</h2>
...
<table class="border_all2" width="60%" border="0" cellspacing="0" cellpadding="1" align="center">
	...
	<tr align="left" class=trForContent1>
		<td align="center" width="643" valign="middle" nowrap class="border_top_right4">&nbsp;&nbsp;&nbsp;&nbsp;用户名称：${userName}</td>
	</tr>
				...
				<table width="58" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td width="58" align="center">
							<input name="addB" type="button" class="button2" value="添 加 &gt;" onClick="moveOptions($('nofuncno'),$('funcno'));">
						</td>
					</tr>
					<tr>
						<td align="center">&nbsp;</td>
					...
					<tr>
						<td align="center">
							<input name="delB" type="button" class="button2" value="&lt; 删 除" onClick="moveOptions($('funcno'),$('nofuncno'));">
						</td>
					</tr>
					<tr>
						<td align="center">&nbsp;</td>
					...
					<tr>
						<td align="center">
							<input name="saveSubmit" type="button" class="button2" value=" 保 存 " onClick="checkForm();">
						</td>
					</tr>
					<tr>
						<td align="center">&nbsp;</td>
					...
					<tr>
						<td align="center">
							<input type="button" class="button2" value=" 返 回 " onclick="javascript:processBack()" />
						</td>
					</tr>
				</table>
				</td>
