...
function moveOptions() { 
	...
	function checkForm() {
		...
		select_all();
		var url="${ctx}/paymentchannelconfigformerchant.htm?method=setItemUpdate";
		var data= $("#testjop1").serialize();
		var memberType=$("#memberType").val();
		if("800" == memberType){
			if(confirm("是否自动为该GC用户自动配置一个2级通道号")){
				url = url + "&auto=1";
			}
		}
...
<table class="border_all2" width="60%" border="0" cellspacing="0" cellpadding="1" align="center">
	<form id="testjop1" action="${ctx}/paymentchannelconfigformerchant.htm?method=setItemUpdate" method="post">
		...
		<table width="617" border="0" cellspacing="0" cellpadding="0">
			...
			<tr align="center">
				...
				<td width="192" align="left">
					...
					<input type="hidden" name="memberType" value="${memberType}" id="memberType"/>
				</td>
				<td width="121">
	...
	<input type="hidden" name="memberCode" value="${paymentChannelItem.memberCode}"/>
	<input type="hidden" name="paymentType" value="${paymentChannelItem.paymentType}"/>
	</form>
</table>
