...
function query(pageNo) {
	...
	$.ajax({
		type: "POST",
		url: "${ctx}/membersecondlimit.htm?method=list",
		data: pars,
...
function deleteConfig(id){
	...
	$.ajax({
		type: "POST",
		url: "${ctx}/membersecondlimit.htm?method=delete",
		data: pars,
		success: function(result) {
			var msg = eval('('+result+')');
...
function editpcc(){
	...
	if('' == limitTimes || isNaN(limitTimes) || !isInt(limitTimes)){
		alert("请输入正确限制笔数！");
		return;
	}

	if('' == limitDay || isNaN(limitDay) || !isInt(limitDay)){
		alert("请输入正确限制天数！");
		return;
	}
...
<body>
<h2 class="panel_title">商户通道限额管理</h2>
		...
		cellpadding="1" align="center">		
			...
			<tr class="trForContent1">
				<td class="border_top_right4" align="center">
					会员号：<input type="text" id="partnerIdSearch" name="partnerId" value="">
				</td>
			</tr>
			<tr class="trForContent1">			
				<td class="border_top_right4"  align="center">
...
<div id="addLogDiv" name="addLogDiv" style="display: none" align="center">
	<form id="setPriorityForm" name="setPriorityForm" >
		<table class="border_all2" width="95%" border="0" cellspacing="0" cellpadding="1" align="center">
			...
			<tr class="trForContent1" align="center" valign="middle">
				<td class="border_top_right4" align="center" nowrap>通道天数限制</td>
				<td class="border_top_right4" align="center" nowrap>
