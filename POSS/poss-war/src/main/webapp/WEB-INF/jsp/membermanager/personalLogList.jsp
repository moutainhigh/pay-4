...
<table width="25%" border="0" cellspacing="0" cellpadding="0"
	...
	<tr>
		<td height="18">
		<div align="center"><font class="titletext">个 人 会 员 日 志  查 询</font></div>
		</td>
	</tr>
	<tr>
		<td height="1" bgcolor="#000000"></td>
		...
		<tr class="trForContent1">
			...
			<td class="border_top_right4" align="left" width="15%">
				<select id="logType" name="logType" size="1">
					...
					<c:forEach items="${logTypeMap}" var="logType">
...
<table class="border_all2" width="80%" border="0" cellspacing="0"
	...
	<c:forEach items="${memberLogList}" var="memberLog" varStatus = "memberLogStatus">
	<c:choose>
       <c:when test="${memberLogStatus.index%2==0}">
             <tr class="trForContent1">
       </c:when>
       <c:otherwise>
