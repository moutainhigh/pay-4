...
function closePage() {
	parent.closePage('signMessageCreateView.do?method=createView');
}
function submitSave() {
	...
	document.getElementById('signMessageViewForm').submit();
}
...
<table width="80%" border="0" cellspacing="0" cellpadding="0" align="center" height="21" >
	...
	<tr>
		<td height="18">
		<div align="center"><font class="titletext">频  道  新  增  </font></div>
		</td>
	</tr>
	<c:if test="${success}">
		<tr>
...
<form id="signMessageViewForm" name="signMessageViewForm" method="post" action="signMessageCreateView.do">
	<input type="hidden" name="method" value="createViewSave"/>
