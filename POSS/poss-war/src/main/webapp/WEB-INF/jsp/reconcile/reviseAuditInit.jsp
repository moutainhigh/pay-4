...
<table width="25%" border="0" cellspacing="0" cellpadding="0"
	...
	<tr>
		<td height="18">
		<div align="center"><font class="titletext">手工调账审核</font></div>
		</td>
	</tr>
	<tr>
		<td height="1" bgcolor="#000000"></td>
...
function queryReviseReconcileAudit(pageNo,totalCount) {
	...
	var pars = $("#mainfrom").serialize() + "&pageNo=" + pageNo + "&totalCount=" + totalCount;
		$.ajax({
			type: "POST",
			//url: "reconcile.reviseReconcile.do?method=queryReviseReconcileAudit",
			url: "reconcile.reviseAudit.do?method=queryReviseAuditList",
			data: pars,
