...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			//条件查询分页
			function logQuery(pageNo,totalCount,pageSize) {
				...
				$.ajax({
					type: "POST",
					url: "${ctx}/fo_rc_foreconcilelogcontroller.do?method=querylogList",
					data: pars,
	...
	<body>
		<table width="25%" border="0" cellspacing="0" cellpadding="0" align="center" height="21">
			...
			<tr>
				<td height="18">
					<div align="center">
						<font class="titletext">调账日志列表</font>
					</div>
				</td>
			</tr>
			<tr>
		...
		<table  class="border_all2" width="80%" border="0" cellspacing="0" cellpadding="1" align="center">
		    ...
		    <tr class="trForContent1">
		      ...
		      <input type="button" onclick="logQuery();" name="submitBtn" value="查  询" class="button2">
		      </td>
		    </tr>
		</table>
		</form>
