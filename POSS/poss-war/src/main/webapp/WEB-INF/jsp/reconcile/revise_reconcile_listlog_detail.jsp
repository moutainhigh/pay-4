...
<table width="25%" border="0" cellspacing="0" cellpadding="0"
	...
	<tr>
		<td height="18">
		<div align="center"><font class="titletext">调账日志详情<!-- 银行 --></font></div>
		</td>
	</tr>
	<tr>
		<td height="1" bgcolor="#000000"></td>
 ...
 <table class="border_all2" width="80%" border="0" cellspacing="0"
    ...
    <tr class="trForContent1">
      <td class=border_top_right4 align="right" width="50%">银行订单号：</td>
      <td class="border_top_right4" width="50%">
        	 ${reconcileAcceptMain.bankSeq }
      </td>
    </tr>  
    <tr class="trForContent1">
    
      <td class=border_top_right4 align="right" width="50%">银行交易金额：</td>
      <td class="border_top_right4" width="50%">
