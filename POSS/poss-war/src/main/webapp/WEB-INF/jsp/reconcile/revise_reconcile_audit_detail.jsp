		...
		<input type="hidden"  name="acceptKy" value="${reconcileAcceptMain.acceptKy}"  />
		 ...
		 <tr  align="center" class="trForContent1"  valign="middle">
		    ...
		    <tr  align="center" class="trForContent1"  valign="middle">
		      ...
		      <td class="border_top_right4" align="left">
		        	<input type="text"  value="${reconcileAcceptMain.bankSeq }"  disabled="disabled"/>
		      </td>
		    </tr>  
		    <tr  align="center" class="trForContent1"  valign="middle">
		    
		      <td class=border_top_right4 align="right" >银行交易金额：</td>
		      <td class="border_top_right4" align="left">
		        	 <input type="text" value='<fmt:formatNumber value="${reconcileAcceptMain.bankAmount}" pattern="#,##0.00"/>'  disabled="disabled"/>
