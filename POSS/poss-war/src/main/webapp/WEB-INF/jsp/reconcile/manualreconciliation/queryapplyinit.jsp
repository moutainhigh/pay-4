...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			//条件查询分页
			function applyQuery(pageNo,totalCount,pageSize) {
				...
				var pars = $("#applySearchForm").serialize() + "&pageNo=" + pageNo + "&totalCount=" + totalCount + "&pageSize=" + pageSize;
				$.ajax({
					type: "POST",
					url: "${ctx}/fo_rc_foreconcileapplycontroller.do?method=queryapplyList",
					data: pars,
	...
	<body>
		<table width="25%" border="0" cellspacing="0" cellpadding="0" align="center" height="21">
			...
			<tr>
				<td height="18">
					<div align="center">
						<font class="titletext">手工调账查询</font>
					</div>
				</td>
			</tr>
			<tr>
		...
		<table  class="border_all2" width="80%" border="0" cellspacing="0" cellpadding="1" align="center">
		    ...
		    <tr class="trForContent1">
		      	...
		      	<td class="border_top_right4" >
		      		<li:select name="REVISE_STATUS" itemList="${reviseStatusList}" />
		      	</td>
		    </tr>
		    <tr class="trForContent1">
		      <td align="center" class="border_top_right4" colspan="4">
		      	<input type="button" onclick="applyQuery();" name="submitBtn" value="查  询" class="button2">
		      </td>
		    </tr>
		</table>
		</form>
