...
function operatorAppeal(status){
	...
	//部门退回	
		...
		document.getElementById('appealStatusCode').value="10";		
...
<table width="25%" border="0" cellspacing="0" cellpadding="0" align="center" height="21">
	...
	<tr>
		<td height="18">
		<div align="center"><font class="titletext">申 诉 待 部 门  处 理</font></div>
		</td>
	</tr>
	<tr>
		<td height="1" bgcolor="#000000"></td>
...
<form id="appealFormBean" name="appealFormBean"  action="appealInfoForDept.do" method="post"  >
...
<table>
	<tr>	
		<td  align="center">	
			<input id="button1" name="button1" type="button" value="处理完毕" onclick="javascript:vaildateAppealState('${appealDto.appealId}','3');">			
		</td>
		<td  align="center">	
			<input id="button2" name="button2" type="button" value="退回" onclick="javascript:vaildateAppealState('${appealDto.appealId}','10');">		
		</td>		
		<td  align="center">	
		 	<input id="button5" name="button5" type="button" value="关闭" onclick="javascript:closePage('appealListForDept.do');">			
		</td>
	</tr>
</table>
