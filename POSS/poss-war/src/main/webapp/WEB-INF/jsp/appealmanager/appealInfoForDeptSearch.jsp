				...
				<table class="border_all2" width="100%" border="0" cellspacing="0" cellpadding="1" align="center">
					...
					<c:forEach items="${appealHistoryList}" var="appealHistory">
						<tr class="trForContent1">
							...
							&nbsp;</td>
							<td class="border_top_right4" align="center" nowrap >&nbsp;${appealHistory.remark }&nbsp;</td>
						</tr>
					</c:forEach>
				</table>
			</td>
...
<table>
	<tr>	 
		<td  align="center">	
		 	<input id="button5" name="button5" type="button" value="关闭" onclick="javascript:closePage('appealInfoForDeptSearch.do?appealId=${appealDto.appealId}');">			
		</td>
	</tr>
</table>
