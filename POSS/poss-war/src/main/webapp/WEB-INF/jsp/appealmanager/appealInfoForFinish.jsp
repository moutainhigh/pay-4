...
function operatorAppeal(status){
	//归档
	if(status=='6'){
		if(document.getElementById('isSelfDuty').value==''){
			alert("是否我司责任不能为空!");
			return ;
		}
		...
		document.getElementById('appealStatusCode').value="6";		
	//退回重处理	
	}else if(status=='11'){
		if(document.getElementById('remark').value==''){
			alert("处理意见不能为空!");
		...
		document.getElementById('appealStatusCode').value="11";		
	//回访
	}else if(status=='4'){
	...
	//撤销
		...
		document.getElementById('appealStatusCode').value="13";
	}
	if(document.getElementById('remark').value!=''){
...
<table width="25%" border="0" cellspacing="0" cellpadding="0" align="center" height="21">
	...
	<tr>
		<td height="18">
		<div align="center"><font class="titletext">申 诉 待 归 档</font></div>
		</td>
	</tr>
	<tr>
		<td height="1" bgcolor="#000000"></td>
...
<table class="border_all2" width="80%" border="0" cellspacing="0" cellpadding="1" align="center">
		...
		<tr class="trForContent1">
			...
			<td class="border_top_right4" align="left" colspan="3">
				<select id="isSelfDuty" name="isSelfDuty" >	
...
<table>
	<tr>	 
		<td  align="center">	
			<input id="button1" name="button1" type="button" value="归档" onclick="javascript:vaildateAppealState('${appealDto.appealId}','6');">			
		</td>
		<td  align="center">	
			<input id="button2" name="button2" type="button" value="退回重处理" onclick="javascript:vaildateAppealState('${appealDto.appealId}','11');">		
		</td>
		<td  align="center">	
			<input id="button3" name="button3" type="button" value="回访" onclick="javascript:vaildateAppealState('${appealDto.appealId}','4');">				
		</td>
		<td  align="center">	
			<input id="button4" name="button4" type="button" value="撤销" onclick="javascript:vaildateAppealState('${appealDto.appealId}','13');">			
		</td>
		<td  align="center">	
		 	<input id="button5" name="button5" type="button" value="关闭" onclick="javascript:closePage('appealListForFinish.do');">			
		</td>
	</tr>
</table>
