...
function merchantQuery(pageNo,totalCount,pageSize) {
	...
	$.ajax({
		type: "POST",
		url: "${ctx}/beautyLandSmsInfoList.htm",
		data: pars,
...
<table width="25%" border="0" cellspacing="0" cellpadding="0"
	...
	<tr>
		<td height="18">
		<div align="center"><font class="titletext">锦 绣 大 地 商 户 短 信 信 息 查 询</font></div>
		</td>
	</tr>
	<tr>
		<td height="1" bgcolor="#000000"></td>
...
<table class="border_all2" width="95%" border="0" cellspacing="0"
	...
	<tr class="trForContent1">
		...
		<td class="border_top_right4" align="right" >商户主IP：</td>
		<td class="border_top_right4" align="left" ><input
			type="text" id="merchantIp" name="merchantIp"></td>
	</tr>
