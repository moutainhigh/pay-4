...
<html>
	...
	<body>
		<table width="25%" border="0" cellspacing="0" cellpadding="0" align="center" height="21" style="">
			...
			<tr>
				<td height="18">
					<div align="center"><font class="titletext">补充报告报文管理</font></div>
				</td>
			</tr>
			<tr>
				<td height="1" bgcolor="#000000"></td>
			...
			<tr>
				<td height="18">
					<div align="center"><font style="color: red; font-size: 15px;"><a style="cursor:hand;" onclick="download();">补充报告报文模板下载</a></font></div>
				</td>
			</tr>
		</table>
		<form action="${ctx}/context_fundout_antimoney.controller.htm?method=submit" method="post" id="frm1" name="frm1" enctype="multipart/form-data">
			<input type="hidden" name="flag" id="flag" value="supplement" />
			<table class="border_all2" width="60%" border="0" cellspacing="0" cellpadding="1" align="center">
				...
				<tr class="trForContent1">
					<td class="border_top_right4" colspan="4">
						<br />
						&nbsp;&nbsp;&nbsp;&nbsp;操作说明：请先下载补充报告模板（普通报文、补报报文、纠错报文共享同一个模板：页面中的红字链接，模板支持最低版本为2007，请保证所有单元格的数据类型都为文本格式），然后按照反洗钱中心给出的约定依次在模板对应位置录入对应的数据，选择报文类型、录入当日报送批次号、文件在批次中的编号以及上传填充数据后的模板后点击提交。文件名生成规则：报文类型和交易报告类型标识＋报告机构编码＋报送日期＋当日报送批次＋文件在该批次中的编号.XML，请确保报文文件名的唯一性，否则会生成失败，成功后请到报文查询下载管理菜单中进行查询下载操作。
					</td>
				</tr>
