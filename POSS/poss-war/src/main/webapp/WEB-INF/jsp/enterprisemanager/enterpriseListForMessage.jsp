...
function enterpriseQuery(pageNo,totalCount,pageSize) {
	...
	$.ajax({
		type: "POST",
		url: "${ctx}/enterpriseMessageList.do",
		data: pars,
...
<!-- <table width="25%" border="0" cellspacing="0" cellpadding="0"
	...
	<tr>
		<td height="18">
		<div align="center"><font class="titletext">商 户 信 息 修 改 查 询</font></div>
		</td>
	</tr>
	<tr>
		<td height="1" bgcolor="#000000"></td>
...
<h2 class="panel_title">商户信息修改查询</h2>
...
<table class="border_all2" width="95%" border="0" cellspacing="0"
	...
	<tr class="trForContent1">
		...
		<td class="border_top_right4" align="left" >
		<input	type="text" id="memberCode" name="memberCode"></td>
