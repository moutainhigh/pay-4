...
<script type="text/javascript">
	...
	function querysearch(pageNo,totalCount,pageSize) {
		...
		var pars = $("#querymainfromId").serialize();
		var url = "batchQuery.htm?method=search";
		if(null!=pageNo){
...
<table width="25%" border="0" cellspacing="0" cellpadding="0"
	...
	<tr>
		<td height="18">
		<div align="center"><font class="titletext">查询补单结果</font></div>
		</td>
	</tr>
	<tr>
		<td height="1" bgcolor="#000000"></td>
 ...
 <form action="" method="post" id="querymainfromId">
