...
$(function(){
	...
	$("#sp_merchant_name").focusout(function(){
		...
		if('' != sp_merchant_name){
			var pars = "sp_merchant_name=" + sp_merchant_name;
			$.ajax({
				type: "POST",
...
function closePage(){
	...
	var url="${ctx}/specialMerchantAdd.do";
...
<table width="25%" border="0" cellspacing="0" cellpadding="0" align="center" height="21">
	...
	<tr>
		<td height="18">
		<div align="center"><font class="titletext">特约商户信息添加</font></div>
		</td>
	</tr>
	<tr>
		<td height="1" bgcolor="#000000"></td>
...
<form method="post" id="specialMerchantFrom" name="specialMerchantFrom" action="${ctx}/specialMerchantAddForResult.do" onsubmit="return(validator(this))" enctype="multipart/form-data"  >
...
<table class="border_all2" width="600" border="0" cellspacing="0" cellpadding="3" align="center">
	<tr class="trForContent1">
		...
		<td class=border_top_right4>
			<input type="text" name="sp_merchant_name" id="sp_merchant_name" valid="required" errmsg="商户名称不能为空!"　/>
			<font color="red">*</font>
		</td>
	</tr>
	<tr class="trForContent1">
		...
		<td class=border_top_right4>
			...
			<select id="range_id" name="range_id" 	 valid="required" errmsg="请选择经营范围!">
				...
				<c:forEach items="${rangIdList}" var="rangIdInfo">
					<option value="${rangIdInfo.enumCode}">${rangIdInfo.enumName}</option>
				</c:forEach>
			</select>
			<font color="red">*</font>
		</td>
	...
	<tr class="trForContent1">
		...
		<td class=border_top_right4>
			<textarea rows="3" cols="30" id="merchant_intro" name="merchant_intro"></textarea>
		 </td>
	</tr>
	<tr class="trForContent1">
		<td class=border_top_right4 nowrap>特约商户地址</td>
		<td class=border_top_right4>
			<textarea rows="2" cols="30" id="addr" name="addr" valid="required" errmsg="特约商户地址不能为空"></textarea>
			<font color="red">*</font>
		 </td>
	</tr>
	<tr class="trForContent1">
		...
		<td class=border_top_right4>
			<input type="text" name="tel" id="tel" maxlength="16" valid="required" errmsg="公司联系人电话不能为空!|公司联系人电话格式不正确"/>&nbsp;&nbsp;
			<font color="red">*</font>
		</td>
	</tr>
	<tr class="trForContent1">
		...
		<td class=border_top_right4>
			<input type="text" name="website_url" id="website_url" valid="isURL" errmsg="网址必须以http:开头"/>&nbsp;&nbsp;
			<font color="red">网址请以http开头</font>
		</td>
	</tr>
	<tr class="trForContent1">
		<td class=border_top_right4 nowrap>特约商户图片</td>
		<td class=border_top_right4>
...
<table class="border_all4" width="75%" border="0" cellspacing="0" cellpadding="0" align="center" id="buttonDisplay">
	<tr class="trbgcolor6" align="center">
		<td align="center" style="text-align: center">
		 	...
		 	<input type="button" value="重置" onclick="javascript:document.specialMerchantFrom.reset()"/>&nbsp;&nbsp;
