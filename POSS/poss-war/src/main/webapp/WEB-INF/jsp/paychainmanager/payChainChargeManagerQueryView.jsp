...
function payChainManagerQuery(pageNo,totalCount,pageSize) {
	...
	*/
	...
	var pars = $("#payChainManagerForm").serialize() +"&pageNo=" + pageNo + "&totalCount=" + totalCount+"&pageSize="+pageSize;
	$.ajax({
		type: "POST",
		url: "${ctx}/payChainChargeManagerQuery.do?method=queryList",
		data: pars,
...
<table width="95%" border="0" cellspacing="0" cellpadding="0"
	...
	<tr>
		<td height="18">
		<div align="center"><font class="titletext">支 付 链 收 款 管 理 查 询</font></div>
		</td>
	</tr>
	<tr>
		<td height="1" bgcolor="#000000"></td>
...
<table class="border_all2" width="95%" border="0" cellspacing="0"
	...
	<tr class="trForContent1"> 
		<td class="border_top_right4" align="right" >收款链接状态：</td>
		<td class="border_top_right4" align="left" >
			<select id="status" name="status">
				<option value="" selected >全部</option>
				<option value="1" <c:if test="${status=='1'}">select</c:if> >生 效</option>	
				<option value="2" <c:if test="${status=='2'}">select</c:if> >关 闭</option>		
		   </select>
		</td>
	...
	<tr class="trForContent1">
		<td class="border_top_right4" colspan="6" align="center">
			<a class="s03" href="javascript:payChainManagerQuery()"><img src="./images/query.jpg" border="0"></a>
