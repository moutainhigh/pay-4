...
<h2 class="panel_title">渠道订单管理</h2>
	...
	<table class="border_all2" width="80%" border="0" cellspacing="0" cellpadding="1" align="center">	
	    ...
	    <tr class="trForContent1">
	     ...
	     <tr class="trForContent1">	
	 	  ...
	 	  <td align="right" class="border_top_right4" >是否已对账：</td>
	      	<td class="border_top_right4">
	      	<select id="reconciliationFlg" name="reconciliationFlg">
				...
				<option value='4'>对账成功,记账失败</option>
				<option value='8'>需要补单</option>
	      	</select>
	     </td>
	     </tr>
	    <tr class="trForContent1">
...
<script type="text/javascript">
	...
	function download(){
		...
		var pars = $("#mainfromId").serialize();
		window.location.href = 	"./channelOrderQueryDownload.do?method=downloadChannel&"+pars;
	}
  </script>