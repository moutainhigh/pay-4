...
<body>
<form method="post" action="${ctx}/if_poss_datamanage/addPricingStrategyDetail.do?method=submit" name="addForm" id="addForm" onsubmit="return check()">

<h2 class="panel_title">管理支付服务 &gt;&gt;新建价格策略明细</h2>
  <table class="border_all2" width="80%" border="0" cellspacing="0" cellpadding="1" align="center">
  <tr class="trForContent1">
    <td class="border_top_right4" width="15%" height="27" align="right">支付服务代码：</td>
    <td class="border_top_right4" width="31%" align="left"><input type="text"
	     readOnly
	    value="${paymentServiceDto.paymentservicecode}"  /></td>
    <td class="border_top_right4" width="18%" align="right">支付服务名称：</td>
    <td class="border_top_right4" width="36%" align="left"><input type="text" 
	     readOnly
	    value="${paymentServiceDto.paymentservicename}"   /></td>
  </tr>
  ...
  <tr class="trForContent1">
    ...
    <td class="border_top_right4" align="left" >
    	<input  type="text"	     readOnly	    value="${pricingStetagyDto.priceStrategyCode}" /></td>
    <td class="border_top_right4" align="right" >价格策略名称：</td>
    <td class="border_top_right4" align="left" >
    	<input  type="text"	    name="pricestrategyname" readOnly	    value="${pricingStetagyDto.priceStrategyName}" />
    </td>
  </tr>
  ...
  <tr class="trForContent1">
    ...
    <td class="border_top_right4" align="left" >
    	<input id="fixedcharge" name="fixedcharge" value='${pricingStrategyCmd.fixedcharge}' />
    	 <font style="font-family:MS Gothic;font-size:30px"></font>(厘)<br>
    </td>
      
    <td class="border_top_right4" align="right" >费率：</td>
    <td class="border_top_right4" align="left" > 
      <input id="chargerate" name="chargerate" value='${pricingStrategyCmd.chargerate}'   />
 ...
 <tr class="trForContent1">
  ...
  <tr class="trForContent1">
    ...
    <td class="border_top_right4" align="left" >
    <input id="maxcharge" name="maxcharge" value='${pricingStrategyCmd.maxcharge}'  />
     <font style="font-family:MS Gothic;font-size:30px"></font>(厘)<br>
     </td>
    <td class="border_top_right4" align="right" >下限：</td>
    <td class="border_top_right4" align="left" >
    <input id="mincharge" name="mincharge" value='${pricingStrategyCmd.mincharge}'  />
     <font style="font-family:MS Gothic;font-size:30px"></font>(厘)<br>
      </td>
  </tr>
  <!-- 
  ...
  <tr class="trForContent1">
	...
	<input type="hidden" name="pricestrategycode" value='${pricingStetagyDto.priceStrategyCode}'>
	<input type="hidden" name="pricestrategytype" value='${pricingStetagyDto.priceStrategyType}'>
	<input type="hidden" name="caculatemethod" value="${pricingStetagyDto.caculateMethod}">
	<input type="hidden" name="invaliddate" id="invaliddate" value='${invaliddate}'>
	<input type="hidden" name="validdate" id="validdate" value='${validdate}'>
    	<input type="submit"  value="确定" />
	    <input type="button"  value="取消" onClick="$U('${ctx}/if_poss_datamanage/managePricingStrategyDetail.do?priceStrategyCode=${pricingStrategyCmd.pricestrategycode}') "/>
    </td>
  </tr>
...
/***
<c:choose>
<c:when test="${1 == pricingStetagyDto.priceStrategyType || 	6 == pricingStetagyDto.priceStrategyType ||	7 == pricingStetagyDto.priceStrategyType ||	8 == pricingStetagyDto.priceStrategyType ||	9 == pricingStetagyDto.priceStrategyType}">
	$E('fixedcharge_format').readOnly=false;
</c:when>

<c:when test="${1 == pricingStetagyDto.priceStrategyType}">
	$E('chargerate').readOnly=true;
</c:when>	

<c:when test="${4 == pricingStetagyDto.priceStrategyType ||	5 == pricingStetagyDto.priceStrategyType ||	7 == pricingStetagyDto.priceStrategyType ||	9 == pricingStetagyDto.priceStrategyType}">
	$E('maxcharge_format').readOnly=false;
</c:when>	

<c:when test="${3 == pricingStetagyDto.priceStrategyType ||	5 == pricingStetagyDto.priceStrategyType ||	6 == pricingStetagyDto.priceStrategyType ||	8 == pricingStetagyDto.priceStrategyType ||	9 == pricingStetagyDto.priceStrategyType}">
	$E('mincharge_format').readOnly=false;
</c:when>	
