...
<body>
<form method="post" action="${ctx}/if_poss_datamanage/prstgytemEditResult.do?priceStrategyCode=${priceStrategyCode}&pricestrategydetailcode=${pricestrategydetailcode}" name="editForm" id="editForm" onsubmit="return check()">

	 
	  <h2 class="panel_title">价格策略配置模板更新</h2>
	  <table class="border_all2" width="80%" border="0" cellspacing="0" cellpadding="1" align="center">
	  <tr class="trForContent1">
	   <td class="border_top_right4" width="18%" align="right">策略名称：</td>
	   <td class="border_top_right4" align="left" >
	    	<input  type="text"	name="templateName" maxlength="20" value='${prStgyTemDTO.templateName}'/>
	    </td>
	   ...
	   <td class="border_top_right4" align="left" >
			<select id="priceStrategyType" name="priceStrategyType"   >
				<c:forEach items="${pricingStrategyCmd.pricestrategytypeMap}" var="item">
					<option value="${item.key}" <c:if test="${item.key == prStgyTemDTO.priceStrategyType}"> selected="selected" </c:if>>
						${item.value}</option>
				</c:forEach>
			</select>
		</td>
	  ...
	  <tr class="trForContent1">
	   ...
	   <td class="border_top_right4" align="left" >
	    	<input id="fixedCharge" name="fixedCharge" value='${prStgyTemDTO.fixedCharge}' />
	    	 <font style="font-family:MS Gothic;font-size:30px"></font>(厘)
	    </td>
	      
	   <td class="border_top_right4" align="right" >费率：</td>
	   <td class="border_top_right4" align="left" > 
	      <input id="chargeRate" name="chargeRate" value='${prStgyTemDTO.chargeRate}'   />
		    <font style="font-family:MS Gothic;font-size:30px"></font>(万分之一)
		  </td>
	  </tr>
	 <tr class="trForContent1">
	   <td class="border_top_right4" align="right">起始金额：</td>
	   <td class="border_top_right4" align="left" >
	    	<input id="rangFrom" name="rangFrom" value='${prStgyTemDTO.rangFrom}'  />
	     	<font style="font-family:MS Gothic;font-size:30px"></font>(厘) 阶梯费用需设置
	     </td>
	   <td class="border_top_right4" align="right" >终止金额：</td>
	   <td class="border_top_right4" align="left" >
	    	<input id="rangTo" name="rangTo" value='${prStgyTemDTO.rangTo}'  />
	     	<font style="font-family:MS Gothic;font-size:30px"></font>(厘)阶梯费用需设置
	      </td>
	  </tr>
	  <tr class="trForContent1">
	   ...
	   <td class="border_top_right4" align="left" >
	    <input id="maxCharge" name="maxCharge" value='${prStgyTemDTO.maxCharge}'  />
	     <font style="font-family:MS Gothic;font-size:30px"></font>(厘)
	     </td>
	   <td class="border_top_right4" align="right" >下限：</td>
	   <td class="border_top_right4" align="left" >
	    <input id="minCharge" name="minCharge" value='${prStgyTemDTO.minCharge}'  />
	     <font style="font-family:MS Gothic;font-size:30px"></font>(厘)
	      </td>
	  </tr>
	  ...
	  <tr class="trForContent1">
	   ...
	   <input type="hidden"	    name="id"	    value="${prStgyTemDTO.id}" />
	    <input type="submit"  value="保 存" />	
	    <input type="button" value="返 回" onClick="$U('${ctx}/if_poss_datamanage/prstgytemInit.do?priceStrategyCode=${priceStrategyCode}&pricestrategydetailcode=${pricestrategydetailcode}')"  />
	    </td>
	  </tr>
