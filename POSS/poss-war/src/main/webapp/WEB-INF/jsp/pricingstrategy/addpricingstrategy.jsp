...
function check() {
	...
	if(!isNull(invaliddate)){
	    	...
	    	if (validdate.length!=0&&invaliddate.length!=0&&isRightDateFormat(validdate)&&isRightDateFormat(invaliddate)) {
...
<body>
<form method="post" action="${ctx}/if_poss_datamanage/addPricingStrategy.do?method=submit" name="addForm"  id="addForm" onsubmit="return check()">

<h2 class="panel_title">管理支付服务 &gt;&gt;设置价格策略</h2>
   <table class="border_all2" width="80%" border="0" cellspacing="0" cellpadding="1" align="center">
  <tr class="trForContent1" >
    <td class="border_top_right4" width="15%" height="27" align="right"><!--<strong>价格策略代码：</strong>--></td>
    
    <td class="border_top_right4" width="31%" align="left">
	  </td>
    <td class="border_top_right4" width="18%" align="right">价格策略名称：</td>
			   ...
			   <td class="border_top_right4" align="right"> 失效日期：</td>
			    ...
			    <td class="border_top_right4" align="left" >
				   &nbsp;<br>
					 ...
					 <input type="hidden" name="paymentservicecode" value="${paymentservicecode}"/>
					 <input type="hidden" name="status" value="0"/>
					 <input type="hidden" name="paymentServiceType" value="${paymentServiceDto.paymentServiceType}"/>
				</td>	 
			  </tr>
			  <tr class="trForContent1" >
			   <td colspan="4" class="border_top_right4" align="center"> <input  type="submit"  value="确　定" />
      <input  type="button"  value="取　消" onClick="$U('${ctx}/if_poss_datamanage/managePricingStrategy.do?paymentservicecode=${paymentservicecode}') "/></td>
			   </tr>
