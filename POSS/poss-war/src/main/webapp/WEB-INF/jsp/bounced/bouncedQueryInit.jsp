...
<form action="" method="post" id="initForm">
	<table class="border_all2" width="80%" border="0" cellspacing="0"
		...
		<tr class="trForContent1">
			...
			<td align="center" class="border_top_right4" colspan="5">
			<input type="button" onclick="javascript:query();" name="submitBtn" value="查  询" class="button2">
			<input type="button" onclick="javascript:download();" name="submitBtn" value="下  载" class="button2">
			<input type="button" onclick="javascript:downloadData();" name="submitBtn" value="申请资料批量导出" class="button2">
			</td>
		</tr>
	</table>
</form>
...
<script type="text/javascript">
	...
	function downloadData(){
		...
		window.location.href = 	"${ctx}/bounced-register.do?method=downloadData&orderIds="+orderIds;
	}
	
	function download(){
		var pars = $("#initForm").serialize()
		window.location.href = 	"${ctx}/bounced-register.do?method=download&"+pars;
	}
	$(function(){
		query();
