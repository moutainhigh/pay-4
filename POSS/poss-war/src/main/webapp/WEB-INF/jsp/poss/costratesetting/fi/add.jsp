...
<body>
	<table width="320" border="0" cellspacing="0" cellpadding="0" align="center" height="21">
			...
			<tr>
				<td height="18">
					<div align="center">
						<font class="titletext">入款银行成本费率配置 — 新增</font>
					</div>
				</td>
			</tr>
			<tr>
	...
	<form id="form1" name="form1" action="${ctx}/report/costRateSetting.do?method=add" method="post">
	  ...
	  <table id="policyTable" border="0" cellpadding="5" cellspacing="0" width="75%">
	     <tr>
	    	<td align="right" width="22%">银行渠道名称：</td>
			<td align="left" width="28%">
	        	<select name="channelNo" id="channelNo">
			    	<c:forEach items="${pciList}" var="pci">
			    		<option value="${pci.id}">${pci.description}</option>
			    	</c:forEach>	        	
	        	</select>	    	
	    	</td>
	    	<td align="right" width="22%">借贷类型：</td>
	    	<td align="left">	    	
	        	<select name="crDrCard" id="crDrCard">
	  ...
	  <span name="page" id="page" align="center" style="color:blue"></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
