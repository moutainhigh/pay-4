...
<script type="text/javascript">
		...
		function mfpCfgQuery(pageNo,totalCount,pageSize){
		  	$('#infoLoadingDiv').dialog('open');
			var pars = $("#form1").serialize() + "&pageNo=" + pageNo + "&totalCount=" + totalCount+ "&pageSize=" + pageSize;
			$.ajax({
				type: "POST",
				url: "${ctx}/report/memberFlowPackageCfg.do?method=query",
				data: pars,
		...
		$(document).ready(function(){mfpCfgQuery();});
</script>
</head>
...
<body>
	<table width="25%" border="0" cellspacing="0" cellpadding="0" align="center" height="21">
			...
			<tr>
				<td height="18">
					<div align="center">
						<font class="titletext">包量会员配置</font>
					</div>
				</td>
			</tr>
			<tr>
...
<form action="" method="post" id="form1" name="form1">
  <table class="border_all2" width="80%" border="0" cellspacing="0"
    ...
    <tr class="trForContent1">
    	<td align="right" class="border_top_right4">记录状态：</td>
    ...
    <tr class="trForContent1">
      <td align="center" class="border_top_right4" colspan="4">
      	<input type="button" onclick="mfpCfgQuery();" name="submitBtn" value="查  询" class="button2">&nbsp;&nbsp;&nbsp;
      	<input type="button" onClick="javascript:window.location.href='${ctx}/report/memberFlowPackageCfg.do?method=addInit';" name="submitBtn" value="新 增" class="button2">
      </td>
    </tr>
  </table>
