...
<script type="text/javascript">
		...
		function userQuery(pageNo,totalCount,pageSize){
			...
			$.ajax({
				type: "POST",
				url: "${ctx}/report/innerMember.do?method=query",
				data: pars,
  ...
  <table class="border_all2" width="80%" border="0" cellspacing="0"
    ...
    <tr class="trForContent1">
    	<td align="right" class="border_top_right4">分子公司名称：</td>
      	<td class="border_top_right4">
	    	<input type="text" name="memberName" maxlength="60">
	    </td>
    ...
    <tr class="trForContent1">
      <td align="center" class="border_top_right4" colspan="4">
      	...
      	<input type="button" onClick="javascript:window.location.href='${ctx}/report/innerMember.do?method=addInit';" name="submitBtn" value="新 增" class="button2">
      </td>
    </tr>
  </table>
