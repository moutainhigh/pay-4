...
function exportExcel(totalCount) {
	if(totalCount <= 0){
		...
		if(validateQuery()){
			...
			window.location="${ctx}/report/gateWayIncome.do?method=list&export=1&"+pars;
		}
	}
}
...
function userQuery(pageNo,totalCount,pageSize){
	...
	$.ajax({
		type: "POST",
		url: "${ctx}/report/gateWayIncome.do?method=list",
		data: pars,
...
<table width="25%" border="0" cellspacing="0" cellpadding="0" align="center" height="21">
		...
		<tr>
			<td height="18">
				<div align="center">
					<font class="titletext">网关收入统计报表</font>
				</div>
			</td>
		</tr>
		<tr>
...
<form action="" method="post" id="form1" name="form1">
  <table width="55%" border="0" cellspacing="0" cellpadding="1" align="center">	
    ...
    <tr>
    	 <td align="right" ><input type="radio" name="operType" id="operType1" value="1" ${operType==1 ? "Checked" : ""}>会员编号：</td>
    	<td >
   ...
   <tr>
    	<td align="right" ><input type="radio" name="operType" id="operType2" value="2" ${operType==2 ? "Checked" : ""}>分子公司：</td>
    	<td colspan="3">
