package com.pay.poss.ipayconst;


import java.util.ArrayList;
import java.util.List;

public class IpayConst {
     ...
     * 可上传的文件类型
     */
    public final static List<String> acceptUploadEXCELType = new ArrayList<String>();

    static {
        acceptUploadEXCELType.add(XLS_TYPE);
        acceptUploadEXCELType.add(XLSX_TYPE);
        acceptUploadEXCELType.add(XLSM_TYPE);
        acceptUploadEXCELType.add(CSV_TYPE);
    }
