...
//                    } 
    ...
    public static void main(String[] args) throws Exception{  
         ...
         // File file = new File("F:/test/com/test/Testng.java");  
				//FtpUtil.upload(file);//把文件上传在ftp上 ///chargeback/10000003781/
				FtpUtil.startDown(f, "e://ftptest/",  "/chargeback/10000003781", "10000003781null1601605312138000440.docx");//下载ftp文件测试   /xxtest
