...
import com.pay.poss.systemmanager.dao.impl.MenuDaoImpl;
import com.pay.poss.systemmanager.dao.impl.RoleDaoImpl;
import com.pay.poss.systemmanager.model.ResMenu;
import com.pay.poss.systemmanager.service.IMenuService;
...
public class MenuServiceImpl implements IMenuService {
	...
	public List<ResMenu>  findAllMenu(){
		...
		try{
			...
			log.debug("MenuServiceImpl.findAllMenu().menuList.size=="+menuList.size()) ;
