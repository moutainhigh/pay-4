...
public class UserFormBean {
	...
	/**
	 * @param userDutyCode the userDutyCode to set
	 */
	...
	public String getUserStatusName() {
		String statusName = "";
		switch (userStatus) {
			case 1:statusName = "激活";break;
			case 0:statusName = "禁用";break;
		}
		return statusName;
	}
	...
	public String getLastLoginTimeFmt() {
		if(StringUtils.hasText(lastLoginTime) && lastLoginTime.indexOf(".")!=-1 ){
