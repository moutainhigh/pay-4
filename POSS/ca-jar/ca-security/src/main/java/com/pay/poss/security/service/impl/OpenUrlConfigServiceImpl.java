...
import com.pay.poss.security.model.OpenUrlConfig;
import com.pay.poss.security.model.OpenUrlIpGroup;
import com.pay.poss.security.service.IOpenUrlConfigService;
...
public class OpenUrlConfigServiceImpl implements IOpenUrlConfigService {
	 ...
	 * 
	 * @see
	 * com.pay.poss.security.service.IOpenUrlConfigService#findOpenUrlConfigByUrl
	 * (java.lang.String)
	 */
	@Override
