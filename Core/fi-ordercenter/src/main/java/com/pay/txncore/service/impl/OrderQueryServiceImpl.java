...
public class OrderQueryServiceImpl implements OrderQueryService {
	...
	public List<QueryDetail> queryIncomeDetailList(
		...
		try {
			String sqlId = "queryIncomeDetailList";
			if(queryDetailPara.getTradeType() != null && !"".equals(queryDetailPara.getTradeType())){
				if(queryDetailPara.getTradeType().contains(",")){
					sqlId = "findIncomeDetailList";
				}
			}
			List<QueryDetail> queryDetailList = queryDAO.findByCriteria(
					sqlId, queryDetailPara, page_offset,pageSize);
