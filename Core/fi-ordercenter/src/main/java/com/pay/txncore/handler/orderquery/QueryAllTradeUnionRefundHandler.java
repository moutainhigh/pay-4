 ...
 * @author chma
 */
public class QueryAllTradeUnionRefundHandler implements EventHandler {

	public final Log logger = LogFactory
			.getLog(QueryAllTradeUnionRefundHandler.class);
	...
	public String handle(String dataMsg) throws HessianInvokeException {
		...
		try {
			...
			List<RefundOrderQueryResultDetail> queryDetails = orderQueryService
					.queryAllTradeUnionRefund(paraMap);
