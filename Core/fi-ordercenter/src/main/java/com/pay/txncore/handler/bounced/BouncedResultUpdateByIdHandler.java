 ...
 * @author chma
 */
public class BouncedResultUpdateByIdHandler implements EventHandler {

	public final Log logger = LogFactory
			.getLog(BouncedResultUpdateByIdHandler.class);
	...
	public String handle(String dataMsg) throws HessianInvokeException {
		...
		try {
			...
			Map listMap = (Map) paraMap.get("bouncedResults");
			BouncedResultDTO vo = MapUtil.map2Object(
					BouncedResultDTO.class, listMap);
			bouncedQueryDAO.update("bouncedResultUpdate",vo);
