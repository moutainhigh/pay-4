 ...
 * @author chma
 */
public class BouncedResultUpdateHandler implements EventHandler {

	public final Log logger = LogFactory
			.getLog(BouncedResultUpdateHandler.class);
	...
	public String handle(String dataMsg) throws HessianInvokeException {
		...
		if (!chargeBackOrders.isEmpty()) {
			bouncedQueryDAO.updateBatch("bouncedResultUpdate", chargeBackOrders);
