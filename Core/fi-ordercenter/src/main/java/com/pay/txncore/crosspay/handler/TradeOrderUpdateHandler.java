...
public class TradeOrderUpdateHandler implements EventHandler {
	...
	public String handle(String dataMsg) throws HessianInvokeException {
		...
		try {
			...
			String doingBouncedAmount = paraMap.get("doingBouncedAmount");
			String checkFlag = paraMap.get("checkFlag");
			String bouncedRemark = paraMap.get("bouncedRemark");
			...
			if(!StringUtil.isEmpty(checkFlag)){
				tradeOrderDTO.setCheckFlag(checkFlag);
			}
			if(!StringUtil.isEmpty(bouncedRemark)){
				tradeOrderDTO.setBouncedRemark(bouncedRemark);
			}
