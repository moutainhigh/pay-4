 ...
 *
 */
public class RefundExceptionBatchDetailDTO {
...
//	EXTEND2
	...
	public String toString() {
		return "RefundExceptionBatchDetailDTO [batchNo=" + batchNo
				+ ", createTime=" + createTime + ", updateTime=" + updateTime
				+ ", channelCreateTime=" + channelCreateTime
				+ ", channelOrderNo=" + channelOrderNo + ", refundResult="
				+ refundResult + ", updateResult=" + updateResult + ", remark="
				+ remark + ", batchDetailNo=" + batchDetailNo + "]";
	}
