...
import com.pay.txncore.crosspay.dao.ExpressTrackingDAO;
import com.pay.txncore.crosspay.model.ExpressTracking;
import com.pay.txncore.crosspay.model.ExpressTrackingCriteria;
...
public class ExpressTrackingServiceImpl implements ExpressTrackingService {
	...
	@Override
	public String countExpressByStatus(Map<String, Object> paraMap) {
		return String.valueOf(expressTrackingDao.countByCriteria("countExpressByStatus", paraMap));
	}
}