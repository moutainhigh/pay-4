...
public enum ExceptionCodeEnum {
	...
	TRANSACTIONS_PAYMENTS("1205","tradeOrder was payment:订单支付中，不要重复支付"),
	...
	CHANNEL_CONFING_FAIL("0050", "商户无可用渠道"),
	...
	//拒付提示
	CHARGE_BACK_WAS_AUDIT("C1001","拒付订单已审核"),
	CHARGE_BACK_CANNNOT_CHANGE_TYPE("C1002","拒付订单不能转其它类型"),
	CHARGE_BACK_AUDIT_FAIL("C1003","拒付审核失败"),

	PRE_AUTH_CAP_AMOUNT("0500","The amount of pre-authorization completing exceeds the amount of pre-authorization request:预授权完成金额大于预授权申请金额"),
	PRE_AUTH_ORDER_NO_EXIST("0501","The pre-authorization order doesn't exist:预授权订单不存在"),
	PRE_AUTH_CAP_CURRENCY_ERR("0502","The currencies of pre-authorization completing and pre-authorization request are dirrerent:预授权完成币种和预授权申请币种不一致"),
	PRE_AUTH_VOID_SUCCESS("0503","The revocation succeeds:撤销成功"),
	PRE_AUTH_VOID_FAIL("0504","The revocation fails:撤销失败"),
	PRE_AUTH_CAP_FAIL("0505","Pre-authorization completing fails:预授权完成失败"),
	PRE_CAP_ALREADY_VOID("0506","Authorization has been revoked , cannot apply for capture:预授权已撤销，不能申请预授权完成"),
	PRE_VOID_ALREADY_VOID("0507","Authorization has been revoked , can't apply again:预授权已撤销，不能重复撤销"),
	;
