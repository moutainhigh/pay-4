 ...
 * 
 */
public class CrosspayApiWftAcquireHandler implements EventHandler {
	...
	public String handle(String dataMsg) throws HessianInvokeException {
		...
		try {
			...
			if(null != paymentResult && null!=paymentResult.getWftBackVo()){
                WftBackVo  vo = paymentResult.getWftBackVo();
                resultMap.put("responseCode", vo.getResponseCode());
                resultMap.put("responseDesc", vo.getResponseDesc());
