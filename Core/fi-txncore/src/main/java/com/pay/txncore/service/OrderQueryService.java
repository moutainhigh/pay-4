...
public interface OrderQueryService {
	...
	List<Map> queryPreAuthApplyInfo(Map<String,Object> params);

	List<Map> queryPreAuthVoidInfo(Map<String,Object> params);

	List<Map> queryPreAuthCapInfo(Map<String,Object> params);
}
