...
public class CardBindOrderServiceImpl implements CardBindOrderService {
	...
	@Override
	public Long getCardBindIdByToken(String token) {
		// TODO Auto-generated method stub
		Long tokenpayid=cardBindOrderDAO.getPayIdbyToken(token);
		return tokenpayid;
	}
