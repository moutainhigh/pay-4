 ...
 */
public class ChinaLocalPayServiceImpl implements ChinaLocalPayService {
	private static Logger logger = LoggerFactory.getLogger(ChinaLocalPayServiceImpl.class);
	private PaymentService paymentService;

	@Override
	public PaymentResult chinaLocaleAcquire(PaymentInfo paymentInfo) {
		...
		try {
			paymentResult = paymentService.payByChinaLocaleChannels(paymentInfo, tradeOrderDTO,
