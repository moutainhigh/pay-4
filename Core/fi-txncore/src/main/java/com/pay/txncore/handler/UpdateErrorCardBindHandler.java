 ...
 * @author chma
 */
public class UpdateErrorCardBindHandler implements EventHandler {
	...
	public String handle(String dataMsg) throws HessianInvokeException {
		...
		try {
			...
			PaymentResult paymentResult = cardBindService.updateErrorCardBindOrder(paymentInfo.getTradeOrderNo());
