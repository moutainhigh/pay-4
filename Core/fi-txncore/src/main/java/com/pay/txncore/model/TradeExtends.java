 ...
 *
 */
public class TradeExtends implements java.io.Serializable {
	...
	public String toString() {
		return "TradeExtends [extOrderInfo1=" + extOrderInfo1
				+ ", extOrderInfo10=" + extOrderInfo10 + ", extOrderInfo2="
				+ extOrderInfo2 + ", extOrderInfo3=" + extOrderInfo3
				+ ", extOrderInfo4=" + extOrderInfo4 + ", extOrderInfo5="
				+ extOrderInfo5 + ", extOrderInfo6=" + extOrderInfo6
				+ ", extOrderInfo7=" + extOrderInfo7 + ", extOrderInfo8="
				+ extOrderInfo8 + ", extOrderInfo9=" + extOrderInfo9
				+ ", ordersIp=" + ordersIp + ", remark1=" + remark1
				+ ", remark2=" + remark2 + ", tradeExtendsNo=" + tradeExtendsNo
