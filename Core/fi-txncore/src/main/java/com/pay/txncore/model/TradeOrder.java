...
public class TradeOrder implements java.io.Serializable {
	...
	public String toString() {
		return "TradeOrder [tradeBaseNo=" + tradeBaseNo + ", tradeOrderNo=" + tradeOrderNo + ", status=" + status
				...
				+ ", tradeType=" + tradeType + ", rate=" + rate + ", beginTime=" + beginTime + ", endTime=" + endTime
				+ ", currencyCode=" + currencyCode + ", respCode=" + respCode + ", respMsg=" + respMsg + ", paymentWay="
				+ paymentWay + ", statusList=" + statusList + ", oldStatus=" + oldStatus + "]";
	}
