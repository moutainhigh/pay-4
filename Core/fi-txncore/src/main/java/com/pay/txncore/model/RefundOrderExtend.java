...
//退款订单的扩展信息 
public class RefundOrderExtend {
	...
	private Long fixedFeeAmount;	//settlementOrder.getFixedFeeSettlementAmount
	...
	//206 退款手续费部分的代码 add by nico.shao 2016-07-11
	private Long smallOrderFixedfeeAmount;		//这是清算订单中的总金额,206 的费用
	private Long smallOrderFixedfeeDelta;		//206费用的Delta值,本次退款，可能是部分退款，所以手续费是按比例还的
	private Long smallOrderFixedfeeRCount;		//返回次数，可以理解为 成功代码的调用次数 
	...
	public Long getSmallOrderFixedfeeDelta(){
		return smallOrderFixedfeeDelta;
	}
	public void setSmallOrderFixedfeeDelta(Long smallOrderFixedfeeDelta){
		this.smallOrderFixedfeeDelta = smallOrderFixedfeeDelta;
	}
	public Long getSmallOrderFixedfeeRCount(){
		return smallOrderFixedfeeRCount ;
	}
	public void setSmallOrderFixedfeeRCount(Long smallOrderFixedfeeRCount){
		this.smallOrderFixedfeeRCount = smallOrderFixedfeeRCount;
	}
	...
	public String toString() {
		...
		return "RefundOrderExtend [refundOrderNo=" + refundOrderNo
				...
				+ ",smallOrderFixedfeeAmount=" + smallOrderFixedfeeAmount +",smallOrderFixedfeeDelta="+smallOrderFixedfeeDelta
				+ ",smallOrderFixedfeeReturnCount" + smallOrderFixedfeeRCount
				+ "]"; 
