...
//	
//	@Test
//	public void imageImageMapDocument222() throws Exception {
//		final Html2Image html2Image = Html2Image.fromHtml("<div>HELLO!<a href='javascript: alert(1);'><img src='http://www.lanbaoo.com/commons/attachment/download/193453/210x210'/></a></div>");
//		html2Image.getImageRenderer().saveImage("html.png");
//		System.out.println("################################################") ;
//		BufferedImage bufferedImage = html2Image.getImageRenderer().getBufferedImage() ;
//		File file = new File("e:\\ PengJiangbo\\test\\test.png") ;
...
//	}
//	@Test
//	public void imageImageMapDocument333() throws Exception {
//		int ii = 3 ;
//		final Html2Image html2Image = Html2Image.fromHtml("<style type='text/css'>"
//			+"table{border-collapse:collapse}"
//			+"table th{background-color:#CCCCFF;}"
//			+"table th, table td{border:solid 1px #e5e5e5; }"
//			+"td{border-top:0px;}"
//			+"td:not:last{border-right:0px;}"
//			+"</style><table cellspacing='0' cellpadding='5' width='80%' >"
//	    	+"<thead>"
//	        +"<th >Currency</th>"	
//	        +"<th>Sub-Total</th>"    
//	        +"<th>Fee</th>"    
//	        +"<th>Total</th>"    
//	        +"<th>contactInfomation</th>"    
//	        +"</thead>"
//	        +"<tbody>"
//	    	+"<td>CNY</td>"	
//	    	+"<td>"+ ii +"</td>"    
