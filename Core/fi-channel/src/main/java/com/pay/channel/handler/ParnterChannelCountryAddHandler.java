 ...
 */
public class ParnterChannelCountryAddHandler implements EventHandler {
    public final Log logger = LogFactory.getLog(ParnterChannelCountryAddHandler.class);
    ...
    public String handle(String dataMsg) throws HessianInvokeException {
        ...
        try {
            ...
            parnterChannelCountryService.createConfig(cc);
