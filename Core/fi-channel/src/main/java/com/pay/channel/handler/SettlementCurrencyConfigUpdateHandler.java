 ...
 */
public class SettlementCurrencyConfigUpdateHandler implements EventHandler {
    public final Log logger = LogFactory.getLog(SettlementCurrencyConfigUpdateHandler.class);
    ...
    public String handle(String dataMsg) throws HessianInvokeException {
        ...
        try {
            ...
            settlementCurrencyConfigService.updateSettlementCurrencyConfig(scc);
