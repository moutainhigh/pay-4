 ...
 * @author chma
 */
public class PaymentChannelItemDefaultBatchAddHandler implements EventHandler {

	public final Log logger = LogFactory
			.getLog(PaymentChannelItemDefaultBatchAddHandler.class);
	...
	public String handle(String dataMsg) throws HessianInvokeException {
		...
		try {
			...
			Integer paymentType = Integer.valueOf(paraMap.get("paymentType")
					.toString());
			Integer memberType = Integer.valueOf(paraMap.get("memberType")
					.toString());
