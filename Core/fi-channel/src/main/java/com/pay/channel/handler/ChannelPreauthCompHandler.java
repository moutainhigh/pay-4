 ...
 * @since 2015年6月11日
 */
public class ChannelPreauthCompHandler implements EventHandler {
    private static Logger logger = LoggerFactory.getLogger(ChannelPreauthCompHandler.class);
	...
	public String handle(String dataMsg) throws HessianInvokeException {
		...
		try {
			ChannelResponseDto channelResponseDto = channelService
					.channelPreauthCompeleted(channelRequest);
