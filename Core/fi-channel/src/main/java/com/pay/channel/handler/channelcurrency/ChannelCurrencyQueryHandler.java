 ...
 */
public class ChannelCurrencyQueryHandler implements EventHandler{
	
	public final Log logger = LogFactory.getLog(ChannelCurrencyQueryHandler.class);
	...
	public String handle(String dataMsg) throws HessianInvokeException {
		...
		try {
			...
			List<ChannelCurrency> channels = channelCurrencyService
					.queryChannelCurrency(cc,page);
