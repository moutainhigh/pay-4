 ...
 */
public class SettlementCurrencyConfigAddHandler implements EventHandler {
    public final Log logger = LogFactory.getLog(SettlementCurrencyConfigAddHandler.class);
    ...
    public String handle(String dataMsg) throws HessianInvokeException {
        ...
        try {
            ...
            settlementCurrencyConfigService.addSettlementCurrencyConfig(scc);
