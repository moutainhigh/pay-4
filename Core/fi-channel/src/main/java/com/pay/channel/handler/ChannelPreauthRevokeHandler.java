 ...
 * @since 2015年6月11日
 */
public class ChannelPreauthRevokeHandler implements EventHandler {
    private static Logger logger = LoggerFactory.getLogger(ChannelPreauthRevokeHandler.class);
	...
	public String handle(String dataMsg) throws HessianInvokeException {
		...
		try {
			ChannelResponseDto channelResponseDto = channelService
					.channelPreauthRevoke(channelRequest);
