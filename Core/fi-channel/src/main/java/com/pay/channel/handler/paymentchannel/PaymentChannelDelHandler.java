 ...
 * @author chma
 */
public class PaymentChannelDelHandler implements EventHandler {

	public final Log logger = LogFactory.getLog(PaymentChannelDelHandler.class);
	...
	public String handle(String dataMsg) throws HessianInvokeException {
		...
		try {
			...
			paymentChannelService.delPaymentChannel(id);
