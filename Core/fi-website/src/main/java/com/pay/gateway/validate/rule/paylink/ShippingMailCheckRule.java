 ...
 * 验证网关版本
 */
public class ShippingMailCheckRule extends MessageRule {
	...
	protected boolean makeDecision(Object validateBean) throws Exception {
		...
		String shippingEmail = crosspayApiRequest.getShippingMail();

		if (!StringUtil.isEmpty(shippingEmail)
				&& IdentityUtil.validateEmail(shippingEmail)) {
			return true;
		} else {
