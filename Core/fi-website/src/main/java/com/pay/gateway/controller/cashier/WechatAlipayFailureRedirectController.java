 ...
 *
 */
public class WechatAlipayFailureRedirectController extends MultiActionController {

	private final Log logger = LogFactory
			.getLog(WechatAlipayFailureRedirectController.class);
	...
	public ModelAndView index(HttpServletRequest request,
		...
		logger.info("WechatAlipayFailureRedirectController method index start...");
