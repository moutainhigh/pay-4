...
<#if Session["userSession"]?exists >
	...
	<div class="header">
			<h1 class="logo"><a href="http://220.168.94.226:8080/website/index.htm?method=indexApp"><img alt="安捷支付" title="安捷支付" src="<@sp.static/>/img/pay/logo.png"></a>
...
<#else>
<div class="header">
		<h1 class="logo"><a href="http://220.168.94.226:8080/website/index.htm?method=indexApp"><img alt="安捷支付" title="安捷支付" src="<@sp.static/>/img/pay/logo_s.png"></a>
		<i class="ver_txt" title="${txt}">${txt}</i>
		</h1>
