...
<#--第二版本 -->
	...
	<#if Session["userSession"]?exists>
		...
		<div class="header">
			<h1 class="logo">
				<a href="${rc.contextPath}/index.htm"><img alt="安捷支付" title="安捷支付"	src="<@sp.static/>/img/v2/pay/logo.jpg"></a>
			</h1>
			<div class="header_bar">
				<a class="pad" href="${rc.contextPath}/app/myAccount.htm"><strong>${verifyName}</strong></a> 您好！ | <a class="pad" href="${rc.contextPath}/logout.htm">退出</a> | <#--<a class="moblie" href="#">手机支付</a> |--> <a class="help" href="${rc.contextPath}/help/index.htm">帮助中心</a>
			</div>
		</div>
		<#else>
		<div class="header">
			...
			<div class="header_bar">
				<a class="pad" href="${rc.contextPath}/corp/myAccount.htm"><strong>${verifyName}</strong></a> 您好！ | <a class="pad" href="${rc.contextPath}/logout.htm?mtype=2">退出</a> | <#--<a class="moblie" href="#">手机支付</a> |--> <a class="help" href="${rc.contextPath}/help/index.htm">帮助中心</a>
			</div>
		</div>
		</#if>
	<#else>
		<div class="header">
			...
			<div class="header_bar">
				<a class="log" href="${rc.contextPath}/outapp.htm?mtype=2">登录</a> - <a class="reg" href="${rc.contextPath}/register.htm">注册</a> | <#--<a class="moblie" href="#">手机支付</a> |--> <a class="help" href="${rc.contextPath}/help/index.htm">帮助中心</a>
			</div>
		</div>
	</#if>
	<!--/header-->
