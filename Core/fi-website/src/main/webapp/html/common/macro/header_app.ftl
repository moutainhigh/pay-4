...
<#if Session["userSession"]?exists && Session["userSession"].scaleType==3>
	...
	<div class="header">
			<h1 class="logo"><a href="${rc.contextPath}/index.htm?method=indexApp"><img alt="安捷支付" title="安捷支付" src="<@sp.static/>/img/pay/logo.png"></a></h1>
			<div class="header_bar"> <span class="pad"><a href="${rc.contextPath}/app/myAccount.htm"><strong>${verifyName}</strong></a> 您好！</span> | <a class="pad" href="${rc.contextPath}/logout.htm">退出</a>  | <a href="${rc.contextPath}/help/index.htm" class="help">帮助中心</a> 
			</div>
	</div>
	<#if index>
