 ...
 * 验证网关版本
 */
public class PayeeBanknumCheckRule extends MessageRule {
	...
	protected boolean makeDecision(Object validateBean) throws Exception {
		...
		String payeeBanknum = crosspayApiRequest.getPayeeBanknum();
		
		if(!StringUtil.isEmpty(payeeBanknum)&&payeeBanknum.trim().length()>64) {
