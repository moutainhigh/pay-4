 ...
 * 验证网关版本
 */
public class DeliverModeCheckRule extends MessageRule {
	...
	protected boolean makeDecision(Object validateBean) throws Exception {
		...
		String deliverMode = crosspayApiRequest.getDeliverMode();
		
		if(!StringUtil.isEmpty(deliverMode)&&deliverMode.trim().length()>1) {
