 ...
 * 验证网关版本
 */
public class FreightOrgCheckRule extends MessageRule {
	...
	protected boolean makeDecision(Object validateBean) throws Exception {
		...
		String freightOrg = crosspayApiRequest.getFreightOrg();
		
		if(!StringUtil.isEmpty(freightOrg) && freightOrg.trim().length() > 128) {
