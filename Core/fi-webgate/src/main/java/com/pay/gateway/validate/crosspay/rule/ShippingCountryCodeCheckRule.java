 ...
 * 验证网关版本
 */
public class ShippingCountryCodeCheckRule extends MessageRule {
	...
	protected boolean makeDecision(Object validateBean) throws Exception {
		...
		String shippingCountryCode = crosspayApiRequest
				.getShippingCountryCode();
		String mcc = crosspayApiRequest.getMcc();
		if(TradeMccEnum.OBJ_TRADE.getCode().equals(mcc)){
			if(!(!StringUtil.isEmpty(shippingCountryCode) && CountryCodeSwitch.isExists(shippingCountryCode))){
