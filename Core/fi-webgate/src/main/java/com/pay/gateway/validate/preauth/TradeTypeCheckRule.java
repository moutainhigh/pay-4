...
public class TradeTypeCheckRule extends MessageRule {
	...
	protected boolean makeDecision(Object validateBean) throws Exception {
		...
		if (TradeTypeEnum.PREAUTH_API.getCode().equals(type)
				||TradeTypeEnum.PREAUTH_CASH.getCode().equals(type)
				||TradeTypeEnum.PREAUTH_COMPLETED.getCode().equals(type)
				||TradeTypeEnum.PREAUTH_REVOCATION.getCode().equals(type)) {
			return true;
		} else {
