 ...
 */
public class ShippingEmailCheckRule extends MessageRule {
    ...
    protected boolean makeDecision(Object validateBean) throws Exception {
        ...
        String shippingCity = onlineRequestDTO.getShippingMail();
        String language = onlineRequestDTO.getLanguage();

        if(StringUtil.isEmpty(shippingCity) || shippingCity.length() <= 128){
            return true;
        }else{
