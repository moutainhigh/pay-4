...
public class CrosspayRequest {
	...
	private String origOrderId;//原商户订单号
	private String captureAmount;//预授权完成金额
	private String requestId;//预授权撤销请求ID
	
	private String language;
	private String cardLimit;
	private String sellerName;
	private String mcc;//行业类型
	...
	private CrosspayResponse crosspayResponse;
	
	private CrosspayApiRecurringResponse crosspayApiRecurringResponse;
	
	public CrosspayApiRecurringResponse getCrosspayApiRecurringResponse() {
		return crosspayApiRecurringResponse;
	}

	public void setCrosspayApiRecurringResponse(
			CrosspayApiRecurringResponse crosspayApiRecurringResponse) {
		this.crosspayApiRecurringResponse = crosspayApiRecurringResponse;
	}
	...
	public CrosspayResponse getCrosspayResponse() {
		return crosspayResponse;
	}

	public void setCrosspayResponse(CrosspayResponse crosspayResponse) {
		this.crosspayResponse = crosspayResponse;
	}
