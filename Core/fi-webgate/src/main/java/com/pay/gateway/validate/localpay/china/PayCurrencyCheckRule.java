 ...
 * 验证网关版本
 */
public class PayCurrencyCheckRule extends MessageRule {
	...
	protected boolean makeDecision(Object validateBean) throws Exception {
		...
		String payCurrency = crosspayApiRequest.getPayCurrency();
		if(!StringUtil.isEmpty(payCurrency)&&payCurrency.trim().length()>3) {
