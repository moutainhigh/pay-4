 ...
 */
public class BillPostalCheckRule extends MessageRule {
    ...
    protected boolean makeDecision(Object validateBean) throws Exception {
        ...
        String billAddress = onlineRequestDTO.getBillPostalCode();
        String language = onlineRequestDTO.getLanguage();

        if(StringUtil.isEmpty(billAddress) || billAddress.length() <= 32){
            return true;
        }else{
