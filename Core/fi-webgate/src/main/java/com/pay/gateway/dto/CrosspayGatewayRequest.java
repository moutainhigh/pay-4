 ...
 *
 */
public class CrosspayGatewayRequest {
	...
	// 返回对象
	private CrosspayGatewayResponse gatewayResponseDTO;
	...
	public CrosspayGatewayResponse getGatewayResponseDTO() {
		return gatewayResponseDTO;
	}

	public void setGatewayResponseDTO(CrosspayGatewayResponse gatewayResponseDTO) {
		this.gatewayResponseDTO = gatewayResponseDTO;
	}
