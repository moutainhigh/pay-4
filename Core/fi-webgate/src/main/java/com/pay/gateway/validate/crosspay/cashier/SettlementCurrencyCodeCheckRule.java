 ...
 */
public class SettlementCurrencyCodeCheckRule extends MessageRule {
    ...
    protected boolean makeDecision(Object validateBean) throws Exception {
        ...
        String settlementCurrencyCode = onlineRequestDTO
        ...
        if (CurrencyCodeEnum.isExists(settlementCurrencyCode)) {
            return true;
        } else {
