 ...
 * 验证网关版本
 */
public class PayeeAddressCheckRule extends MessageRule {
	...
	protected boolean makeDecision(Object validateBean) throws Exception {
		...
		String payeeAddress = crosspayApiRequest.getPayeeAddress();
		if(!StringUtil.isEmpty(payeeAddress)&&payeeAddress.trim().length()>256) {
