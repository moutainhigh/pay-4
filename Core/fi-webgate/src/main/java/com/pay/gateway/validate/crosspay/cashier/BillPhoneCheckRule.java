 ...
 */
public class BillPhoneCheckRule extends MessageRule {
    ...
    protected boolean makeDecision(Object validateBean) throws Exception {
        ...
        String billAddress = onlineRequestDTO.getBillPhoneNumber();
        String language = onlineRequestDTO.getLanguage();

        if(StringUtil.isEmpty(billAddress) || billAddress.length() <= 64){
            return true;
        }else{
