 ...
 * 
 */
public class ZsyCashierAcquireController extends MultiActionController {

	private final Log logger = LogFactory
			.getLog(ZsyCashierAcquireController.class);
	...
	public ModelAndView index(HttpServletRequest request,
		...
		cashierRequest.setOrderAmount(new BigDecimal(orderAmount).multiply(new BigDecimal("100")).longValue()+"");
		cashierRequest.setPayType("all");
