...
public class GatewayRequestDAOImpl extends BaseDAOImpl<GatewayRequest>
	...
	@Override
	public List<GatewayRequest> queryGatewayRequest(Long memberCode, String orderId, String businessType) {
		Map queryParams = new HashMap();
		queryParams.put("orderId", orderId);
		queryParams.put("memberCode", memberCode);
		queryParams.put("businessType", businessType);
		return super.findByQuery("queryByOrderIdAndBusinessType",queryParams);
	}
}