 ...
 * 验证网关版本
 */
public class CardHolderEmailCheckRule extends MessageRule {
	...
	protected boolean makeDecision(Object validateBean) throws Exception {
		...
		String cardHolderEmail = crosspayApiRequest.getCardHolderEmail();

		if (!StringUtil.isEmpty(cardHolderEmail)
				&& IdentityUtil.validateEmail(cardHolderEmail)&&cardHolderEmail.length()<=128) {
			return true;
		} else {
