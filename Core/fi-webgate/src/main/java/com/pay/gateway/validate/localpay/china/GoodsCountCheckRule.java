 ...
 * 验证订单号
 */
public class GoodsCountCheckRule extends MessageRule {
	...
	protected boolean makeDecision(Object validateBean) throws Exception {
		...
		String goodsCount = crosspayApiRequest.getGoodsCount();

		if (StringUtil.isEmpty(goodsCount)||goodsCount.trim().length()>18
				||!NumberUtil.isNumber(goodsCount)) {
