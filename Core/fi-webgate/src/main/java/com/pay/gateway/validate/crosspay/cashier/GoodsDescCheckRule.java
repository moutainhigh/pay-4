 ...
 */
public class GoodsDescCheckRule extends MessageRule {
    ...
    protected boolean makeDecision(Object validateBean) throws Exception {
        ...
        String goodsDesc = onlineRequestDTO.getGoodsDesc();
        String language = onlineRequestDTO.getLanguage();

        if (!StringUtil.isEmpty(goodsDesc) && goodsDesc.trim().length() <= 2000) {
            return true;
        } else {
