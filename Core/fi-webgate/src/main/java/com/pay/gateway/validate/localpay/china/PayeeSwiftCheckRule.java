 ...
 * 验证网关版本
 */
public class PayeeSwiftCheckRule extends MessageRule {
	...
	protected boolean makeDecision(Object validateBean) throws Exception {
		...
		String payeeSwift = crosspayApiRequest.getPayeeSwift();
		
		if(!StringUtil.isEmpty(payeeSwift)&&payeeSwift.trim().length()>128) {
