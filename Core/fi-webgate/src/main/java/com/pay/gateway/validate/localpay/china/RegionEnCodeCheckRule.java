 ...
 * 验证网关版本
 */
public class RegionEnCodeCheckRule extends MessageRule {
	...
	protected boolean makeDecision(Object validateBean) throws Exception {
		...
		String regionEnCode = crosspayApiRequest.getRegionEnCode();
		
		if(!StringUtil.isEmpty(regionEnCode)&&regionEnCode.trim().length()>3) {
