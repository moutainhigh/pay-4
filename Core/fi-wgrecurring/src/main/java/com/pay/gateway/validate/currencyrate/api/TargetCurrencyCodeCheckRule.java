 ...
 * 验证网关版本
 */
public class TargetCurrencyCodeCheckRule extends MessageRule {
	...
	protected boolean makeDecision(Object validateBean) throws Exception {
		...
		String targetCurrencyCode = crosspayApiRequest
				.getTargetCurrency();

		if (CurrencyCodeEnum.isExists(targetCurrencyCode)) {
			return true;
		} else {
