...
public class MerchantChannelCheckRule extends MessageRule {
	...
	protected boolean makeDecision(Object validateBean) throws Exception {
		...
		TradeRevokeApiResponse traderRevokeApiResponse = tradeRevokeApiRequest
				.getTradeRevokeApiResponse();

		String memberCode = tradeRevokeApiRequest.getPartnerId();
		...
		if (null != paymentChannelItems && !paymentChannelItems.isEmpty()) {
			...
			traderRevokeApiResponse.setResultCode(getMessageId());
			traderRevokeApiResponse.setResultMsg(getMessage());
			return false;
		}
