...
public class BuySettleOrderQueryByMapHandler implements EventHandler {
	private BuySettleOrderService BuySettleOrderServiceImpl;
	Log logger = LogFactory.getLog(BuySettleOrderQueryByMapHandler.class);
	...
	public String handle(String dataMsg) throws HessianInvokeException {
		...
		try {
			...
			Map<String,Object> busettleOrder = (Map<String, Object>) paraMap.get("BuysettleOrder");
			...
			List<BuysettleOrder> busettleOrderList = BuySettleOrderServiceImpl.queryByConditionsList(busettleOrder);
