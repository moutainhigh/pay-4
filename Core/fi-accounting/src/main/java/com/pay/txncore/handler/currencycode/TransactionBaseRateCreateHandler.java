 ...
 * @since 2015年6月29日
 */
public class TransactionBaseRateCreateHandler implements EventHandler {

	public final static String DEFAULT_DATE_FROMAT = "yyyy-MM-dd HH:mm:ss";
	public final Log logger = LogFactory
			.getLog(TransactionBaseRateCreateHandler.class);
	...
	public String handle(String dataMsg) throws HessianInvokeException {
		...
		try {
			...
			List<TransactionBaseRate> rates = null;
			if (null != listMap && !listMap.isEmpty()) {
				rates = new ArrayList<TransactionBaseRate>();
				for (Map map : listMap) {
					...
					TransactionBaseRate rate = new TransactionBaseRate();
			...
			currencyRateService.createTransactionBaseRate(rates);
