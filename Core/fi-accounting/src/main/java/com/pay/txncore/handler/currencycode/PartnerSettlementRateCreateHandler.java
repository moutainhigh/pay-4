 ...
 * @author peiyu.yang
 */
public class PartnerSettlementRateCreateHandler implements EventHandler {

	public final static String DEFAULT_DATE_FROMAT = "yyyy-MM-dd HH:mm:ss";
	public final Log logger = LogFactory
			.getLog(PartnerSettlementRateCreateHandler.class);
	...
	public String handle(String dataMsg) throws HessianInvokeException {
		...
		try {
			...
			SettlementRate exchangeRate = new SettlementRate();
			...
			List<SettlementRate> list = settlementRateService
	...
	public void setSettlementRateService(
			SettlementRateService settlementBaseRateService) {
		this.settlementRateService = settlementBaseRateService;
	}
