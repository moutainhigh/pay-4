 ...
 * @author peiyu.yang
 */
public class PartnerTransactionRateCreateHandler implements EventHandler {

	public final static String DEFAULT_DATE_FROMAT = "yyyy-MM-dd HH:mm:ss";
	public final Log logger = LogFactory
			.getLog(PartnerTransactionRateCreateHandler.class);
	...
	public String handle(String dataMsg) throws HessianInvokeException {
		...
		try {
			...
			TransactionRate exchangeRate = new TransactionRate();
			...
			List<TransactionRate> list = transactionRateService
