...
public class PartnerSettlementOrderServiceImpl implements
	...
	@Override
	public List<PartnerSettlementOrder> querySettlementOrderForCredit(
			Map paraMap) {
		return partnerSettlementOrderDAO.findByCriteria(
				"querySettlementOrderForCredit", paraMap);
	}
	@Override
	public List<PartnerSettlementOrder> querySettlementOrderForTotal(
			Map paraMap) {
		return partnerSettlementOrderDAO.findByCriteria(
				"querySettlementOrderForTotal", paraMap);
	}
	
	@Override
	public List<CreditFilterOrder> queryChargeBackForCredit(String beginDate,String endDate, String creditFlag)  {
		Map paraMap = new HashMap();
		paraMap.put("beginDate", beginDate);
		paraMap.put("endDate", endDate);
		paraMap.put("creditFlag",creditFlag);
		return partnerSettlementOrderDAO.findByCriteria(
				"queryChargeBackForCredit", paraMap);
	}

	@Override
	public List<PartnerSettlementOrder> queryOrderCreditSettlementOrder(
			PartnerSettlementOrder order) {
		return partnerSettlementOrderDAO.findByCriteria(
	...
	public List<PartnerSettlementOrder> queryOrderCreditSettlementOrder(
			PartnerSettlementOrder order,Page page) {
		return partnerSettlementOrderDAO.findByCriteria(
				"queryOrderCreditSettlementOrder", order,page);
	}
}
