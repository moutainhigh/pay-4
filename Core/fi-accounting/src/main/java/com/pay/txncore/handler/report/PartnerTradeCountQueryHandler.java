 ...
 * @author chma
 */
public class PartnerTradeCountQueryHandler implements EventHandler {

	public final Log logger = LogFactory.getLog(PartnerTradeCountQueryHandler.class);
	...
	public String handle(String dataMsg) throws HessianInvokeException {
		...
		try {
			...
			List<PartnerTradeCountDTO> list = tradeCountDAO.getPartnerTradeCountDTOs(map);
