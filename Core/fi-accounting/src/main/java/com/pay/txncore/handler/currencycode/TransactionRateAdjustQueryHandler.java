 ...
 * @author peiyu.yang
 */
public class TransactionRateAdjustQueryHandler implements EventHandler {

	public final static String DEFAULT_DATE_FROMAT = "yyyy-MM-dd HH:mm:ss";
	public final Log logger = LogFactory
			.getLog(TransactionRateAdjustQueryHandler.class);
	...
	public String handle(String dataMsg) throws HessianInvokeException {
		...
		try {
			...
			TransactionRateAdjust exchangeRate = new TransactionRateAdjust();
			...
			List<TransactionRateAdjust> list = transactionRateAdjustService
