...
<div id="sidermenu" class="sub_nav fl">
	    ...
	    <h3 ><a id="a4" class="hide" href="javascript:void(0)">生活管家</a></h3>
	       <ul style="display:none" id="4">
			    <#--<li><a <#if channel=4+"_"+1>class="cur"</#if> href="<@contextPath/>/baseHelp.htm?method=lifeMyPayment">GCPayment支付</a></li>
	    ...
	    <#--<h3 ><a class="hide" href="<@contextPath/>/help.htm?method=helppayayPays&securityType=0"GCPayment支付支付款</a></h3>   -->
