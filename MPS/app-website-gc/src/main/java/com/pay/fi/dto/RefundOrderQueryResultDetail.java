...
public class RefundOrderQueryResultDetail implements java.io.Serializable {
	
	private String refundOrderID;	//商户退款订单号	refundOrderID  退款查询结果明细 3.4.4
	...
	public String toString() {
		return "RefundOrderQueryResultDetail [applyAmount=" + applyAmount
