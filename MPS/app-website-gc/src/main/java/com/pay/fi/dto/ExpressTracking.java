...
public class ExpressTracking {
	...
	//运单上传失败原因
	private String uploadFailRemark ;
	...
	/**
	 * @return the uploadFailRemark
	 */
	public String getUploadFailRemark() {
		return uploadFailRemark;
	}

	public void setUploadFailRemark(String uploadFailRemark) {
		this.uploadFailRemark = uploadFailRemark;
	}

	@Override
	public String toString() {
		return "ExpressTracking [id=" + id + ", partnerId=" + partnerId
				+ ", orderId=" + orderId + ", tradeOrderNo=" + tradeOrderNo
				+ ", siteId=" + siteId + ", payerAuth=" + payerAuth
				+ ", language=" + language + ", billName=" + billName
				+ ", billAdress=" + billAdress + ", billEmail=" + billEmail
				...
				+ billCountryCode + ", shippingName=" + shippingName
				+ ", shippingAddress=" + shippingAddress + ", shippingMail="
				+ shippingMail + ", shippingPhoneNumber=" + shippingPhoneNumber
				+ ", shippingPostalCode=" + shippingPostalCode
				+ ", shippingCompany=" + shippingCompany + ", shippingStreet="
				+ shippingStreet + ", shippingCity=" + shippingCity
				+ ", shippingState=" + shippingState + ", shippingCountryCode="
				+ shippingCountryCode + ", cardHolderNumber="
				+ cardHolderNumber + ", cardHolderFirstName="
				+ cardHolderFirstName + ", cardHolderLastName="
				+ cardHolderLastName + ", cardExpirationMonth="
				+ cardExpirationMonth + ", cardExpirationYear="
				+ cardExpirationYear + ", cardHolderEmail=" + cardHolderEmail
				+ ", cardHolderPhoneNumber=" + cardHolderPhoneNumber
				+ ", deviceFingerprintid=" + deviceFingerprintid
				+ ", trackingNo=" + trackingNo + ", uploadeDate=" + uploadeDate
				+ ", completeFlg=" + completeFlg + ", status=" + status
				+ ", expressCom=" + expressCom + ", queryUrl=" + queryUrl
				+ ", expressFee=" + expressFee + ", remark=" + remark
				+ ", createDate=" + createDate + ", updateDate=" + updateDate
				+ ", auditTime=" + auditTime + ", orderAmount=" + orderAmount
				+ ", currencyCode=" + currencyCode + ", operator=" + operator
				+ ", beginTime=" + beginTime + ", endTime=" + endTime
				+ ", checkStartTime=" + checkStartTime + ", checkEndTime="
				+ checkEndTime + "]";
	}
