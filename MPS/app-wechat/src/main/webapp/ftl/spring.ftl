...
<#macro seo>http://home.pay.com</#macro>
...
<#include "common/macro/corpbill.ftl">
<#include "common/macro/notice.ftl">
<#include "common/macro/banner.ftl">
<#include "common/macro/corpBanner.ftl">
<#include "common/macro/menu.ftl">
<#include "common/macro/helpMenu.ftl">
<#include "common/macro/individMenu.ftl">
<#include "common/macro/pager.ftl">
<#include "common/macro/agreement.ftl">
<#include "common/macro/matrixcard.ftl">
<#include "common/macro/matrixLogin.ftl">
<#include "common/macro/ebillheader.ftl">
<#include "common/macro/ebillmenu.ftl">
<#include "common/macro/hasFeature.ftl">
<#include "common/macro/hasMenu.ftl">
<#include "common/macro/password.ftl">
<#include "common/macro/headerHelp.ftl">
<#include "common/macro/helpCenterMenu.ftl">
<#include "common/macro/newHelpMenu.ftl">
<#include "common/macro/showMenu.ftl">
<#include "common/macro/helpBanner.ftl">
<#include "common/macro/footMenu.ftl">
<#include "common/macro/footHeader.ftl">
<#include "common/macro/header_common.ftl">
<#include "common/macro/resultClass.ftl">
<#include "common/macro/agree.ftl">
<#include "common/macro/page.ftl">
<#include "common/macro/uploadContext.ftl">
<#include "common/macro/hasProduct.ftl">
<#--改版增加的-->
<#include "common/macro/headerV2_common.ftl">
<#include "common/macro/areaCity.ftl">