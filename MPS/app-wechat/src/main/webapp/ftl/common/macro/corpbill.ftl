...
<div id="fader" >
		...
		<#list imgList as img>
				...
				<#--
				<li><a href="#" target="_blank"><img width="720" height="180" alt="" title="" src="<@sp.static/>img/pay/index/focus2.jpg" /></a></li>
				<li><a href="#" target="_blank"><img width="720" height="180" alt="" title="" src="<@sp.static/>img/pay/index/f_3.jpg" /></a></li>-->
			</#list>
		</ul>
	</div>
