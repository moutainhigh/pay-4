...
public class QueryDetail implements Serializable {
	...
	public String toString() {
		return "QueryDetail [createDate=" + createDate + ", payDate=" + payDate
				+ ", tradeOrderNo=" + tradeOrderNo + ", orderId=" + orderId
				+ ", payChannel=" + payChannel + ", payStatus=" + payStatus
				+ ", notifyStatus=" + notifyStatus + ", payType=" + payType
				+ ", orderStatus=" + orderStatus + ", orderAmount="
				+ orderAmount + ", opStatus=" + opStatus + ", partnerId="
				+ partnerId + ", completeDate=" + completeDate
