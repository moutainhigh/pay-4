...
public class PayUrlRewriteFilter extends UrlRewriteFilter {
	private static Log log = Log.getLog(PayUrlRewriteFilter.class);
	...
	public void doFilter(final ServletRequest request, final ServletResponse response, final FilterChain chain) throws IOException, ServletException {
		...
		if (urlRewriter != null) {
			RequestLocal.setRequestLocal(hsRequest);
			RequestLocal.setResponseLocal(urlRewriteWrappedResponse);
			// process the request
