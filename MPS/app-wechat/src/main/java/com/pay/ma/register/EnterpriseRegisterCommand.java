...
public class EnterpriseRegisterCommand {
	...
	public String getPayPassWordConfirm() {
		return payPassWordConfirm;
	}

	public void setPayPassWordConfirm(String payPassWordConfirm) {
		this.payPassWordConfirm = payPassWordConfirm;
	}

	@Override
	public String toString() {
		return "EnterpriseRegisterCommand [loginName=" + loginName
				+ ", loginPwd=" + loginPwd + ", loginPwdConfirm="
				+ loginPwdConfirm + ", legalName=" + legalName + ", email="
				+ email + ", legalLink=" + legalLink + ", tel=" + tel
				+ ", zhName=" + zhName + ", region=" + region + ", city="
				+ city + ", address=" + address + ", regionBank=" + regionBank
				+ ", cityBank=" + cityBank + ", branchBankId=" + branchBankId
				+ ", bigBankName=" + bigBankName + ", bankId=" + bankId
				+ ", bankAcct=" + bankAcct + ", acctName=" + acctName
				+ ", payPassWord=" + payPassWord + ", payPassWordConfirm="
				+ payPassWordConfirm + "]";
	}
