...
public class QueryDetailParaDTO implements Serializable {
	...
	public String toString() {
		return "QueryDetailParaDTO [startTime=" + startTime + ", endTime="
				+ endTime + ", payStartTime=" + payStartTime + ", payEndTime="
				+ payEndTime + ", payStatus=" + Arrays.toString(payStatus)
				+ ", payChannel=" + payChannel + ", orderSeq=" + orderSeq
				+ ", memberCode=" + memberCode + ", serialNo=" + serialNo
				+ ", notifyStatus=" + notifyStatus + ", sOrderAmount="
				+ sOrderAmount + ", eOrderAmount=" + eOrderAmount
				+ ", orderStatus=" + orderStatus + ", protocolNo=" + protocolNo
				+ ", pnrCode=" + pnrCode + ", frozenAmount=" + frozenAmount
				+ "]";
	}
