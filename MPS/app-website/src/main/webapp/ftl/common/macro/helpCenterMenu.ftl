	...
	<div class="box_side" id="box_side">
		...
		<div class="side_nav ">
			...
			<dl>
				...
				<dd class="<#if child==2>show<#else>hide</#if>"><a <#if item==21>class="a_cur"</#if> href="${rc.contextPath}/help/p/about.htm">了解GCPayment支付</a></dd>
		...
		<div class="servers_link mt10">
			<p>客服热线：</p>
			<strong>400 665 0719</strong> </div>
		<div class="advise_link"> <a href="${rc.contextPath}/baseHelp.htm?method=centerHelpAdvice"><img title="给GCPayment支付提建议 " src="<@sp.static/>/img/pay/help/advise.png"></a> </div>
	</div>
</#macro>