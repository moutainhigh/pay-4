...
public interface PayMailService {
	...
	public boolean sendMail(String membercode, List<String> recAddress,
			CheckCode checkCode, String url, long templateId, String subject);
	 ...
	 * @param origin
	 */
	void saveCheckCode(String str, String memberCode, String origin,
	 ...
	 * @param checkcode
	 */
	CheckCode getByCheckCode(String checkcode);

	CheckCode getByMemerCode(String memerCode);
