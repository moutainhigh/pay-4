...
public class IpAddress {
   ...
   //数据库地址
   private String dataPath = "/opt/pay/config/ma/QQWry.dat";
   //随机文件访问类
   ...
   */
   public String IpStringToAddress(String ip) {
     ...
     //  System.out.println("ipOffset=="+ipOffset);
   ...
   */
   ...
   public static void main(String[] args) throws UnknownHostException {
       ...
       //测试
       str = ipAddr.IpStringToAddress("116.235.55.251");
       ...
       String countrys=ipAddr.IpStringToAddress("116.235.55.251");
       int i=countrys.indexOf("省");
		 if(i>=0){
			 countrys=countrys.substring(0, i);
		 }else{
			 i=countrys.indexOf("市");
			 countrys=countrys.substring(0, i+1);
		 }
