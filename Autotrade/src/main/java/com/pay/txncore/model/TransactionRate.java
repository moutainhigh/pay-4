...
public class TransactionRate {
	...
	public String toString() {
		return "TransactionRate [id=" + id + ", memberCode=" + memberCode
				+ ", rateTag=" + rateTag + ", currencyDesc=" + currencyDesc
				+ ", currency=" + currency + ", currencyUnit=" + currencyUnit
				+ ", targetCurrency=" + targetCurrency + ", exchangeRate="
				+ exchangeRate + ", reverseExchangeRate=" + reverseExchangeRate
				+ ", effectDate=" + effectDate + ", expireDate=" + expireDate
				+ ", createDate=" + createDate + ", updateDate=" + updateDate
				+ ", status=" + status + ", operator=" + operator
				+ ", cardOrg=" + cardOrg + ", leastTransAmount="
				+ leastTransAmount + ", startPoint=" + startPoint
				+ ", endPoint=" + endPoint + ", ltaCurrencyCode="
				+ ltaCurrencyCode + ", markup=" + markup + "]";
	}
