 ...
 * @file 		EnterpriseListForProductController.java 
 * @note		<br>
...
public class EnterpriseListForProductController extends SimpleFormController {

	private Log log = LogFactory.getLog(EnterpriseListForProductController.class);
	private IEnterpriseService enterpriseService;
	
	@Override
	protected Map<String,Object> referenceData(HttpServletRequest request) throws Exception {
		log.debug("EnterpriseListForProductController.referenceData is running...");
		return null;
	}
	...
	protected ModelAndView onSubmit(HttpServletRequest request, HttpServletResponse response, Object command,
		...
		log.debug("EnterpriseListForProductController.onSubmit is running...");
