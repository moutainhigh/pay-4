 ...
 * @Description 
 * @project 	ma-manager
 * @file 		AppealInfoForDeptController.java 
 * @note		<br>
...
public class AppealInfoForDeptController extends SimpleFormController{
	
	private Log log = LogFactory.getLog(AppealInfoForDeptController.class);
	private IAppealService appealService ;
	private IDataService dataService;
	
    @Override
	protected Map<String,Object> referenceData(HttpServletRequest request) throws Exception {
    	log.debug("AppealInfoForDeptController.referenceData() is running...");
    ...
    protected ModelAndView onSubmit(HttpServletRequest request, HttpServletResponse response, Object command,
    	...
    	log.debug("AppealInfoForDeptController.onSubmit() is running...");
