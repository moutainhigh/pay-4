 ...
 * @Description 
 * @project 	ma-manager
 * @file 		AppealInfoForAdminSearchController.java 
 * @note		<br>
...
public class AppealInfoForAdminSearchController extends SimpleFormController{
	
	private Log log = LogFactory.getLog(AppealInfoForAdminSearchController.class);
	private IAppealService appealService ;
	private IDataService dataService;
	
    @Override
	protected Map<String,Object> referenceData(HttpServletRequest request) throws Exception {
    	log.debug("AppealInfoForAdminSearchController.referenceData() is running...");
    ...
    protected ModelAndView onSubmit(HttpServletRequest request, HttpServletResponse response, Object command,
    	...
    	log.debug("AppealInfoForAdminSearchController.onSubmit() is running...");
    	return null;
   }
