 ...
 * @Description 
 * @project 	ma-manager
 * @file 		AppealInfoForDeptSearchController.java 
 * @note		<br>
...
public class AppealInfoForDeptSearchController extends SimpleFormController{
	
	private Log log = LogFactory.getLog(AppealInfoForDeptSearchController.class);
	private IAppealService appealService ;
	private IDataService dataService;
	
    @Override
	protected Map<String,Object> referenceData(HttpServletRequest request) throws Exception {
    	log.debug("AppealInfoForDeptSearchController.referenceData() is running...");
