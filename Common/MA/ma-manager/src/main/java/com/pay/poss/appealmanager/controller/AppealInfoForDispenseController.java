 ...
 * @Description 
 * @project 	ma-manager
 * @file 		AppealInfoForDispenseController.java 
 * @note		<br>
...
public class AppealInfoForDispenseController extends SimpleFormController{
	
	private Log log = LogFactory.getLog(AppealInfoForDispenseController.class);
	private IAppealService appealService ;
	private IDataService dataService;
	
    @Override
	protected Map<String,Object> referenceData(HttpServletRequest request) throws Exception {
    	log.debug("AppealInfoForDispenseController.referenceData() is running...");
    ...
    protected ModelAndView onSubmit(HttpServletRequest request, HttpServletResponse response, Object command,
    	...
    	log.debug("AppealInfoForDispenseController.onSubmit() is running...");
