...
public interface Constants {
	...
	//安全问题答案
	public static final String SECURITYANSWER = "pay";
	//与sso关联的用户id
	...
	public static final String EMAIL_TITLEFORMARKET = "商户审核通过通知";
	//来源
	public static final String ORIGIN = "poss_active_merchant";
	//邮件激活通知中的激活路径
	//请使用PossPropertiesUtil#getWebsiteContextPath得到上下文地址+EMAIL_ACTIVATION_URI = EMAIL_ACTIVATIONURL
	
	//邮件激活通知中的邮件内容模板
	public static final Long EMAIL_TEMPID = Long.valueOf(13);
	public static final Long EMAIL_TEMPIDOfMARKET = Long.valueOf(2004);
	//邮件类型
	public static final String EMAILTYPE_1= "商户激活通知";
	public static final String EMAILTYPE_2= "补发商户激活通知";
	//部门
	...
	//默认贷方发生额
	public static final Long TOTALBALANCE = Long.valueOf(0);
	//默认账户状态-0无效
