...
public class CalFeeRequestDto implements Serializable {
	...
	public String toString() {
		return "CalFeeRequestDto [amount=" + amount + ", dealCode=" + dealCode
				+ ", exchangeRate=" + exchangeRate + ", orderAmount="
				+ orderAmount + ", orderCode=" + orderCode + ", orderId="
				+ orderId + ", payMethod=" + payMethod + ", payee=" + payee
				+ ", payeeAcctType=" + payeeAcctType + ", payeeCurrencyCode="
				+ payeeCurrencyCode + ", payeeFullMemberAcctCode="
				...
				+ ", payerFullMemberAcctCode=" + payerFullMemberAcctCode
				+ ", payerMemberAcctCode=" + payerMemberAcctCode
				+ ", payerOrgCode=" + payerOrgCode + ", payerOrgType="
				+ payerOrgType + ", payerServiceLevel=" + payerServiceLevel
				+ ", paymentServicePkgCode=" + paymentServicePkgCode
				+ ", requestDate=" + requestDate + ", submitAcctCode="
