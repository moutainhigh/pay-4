...
import com.pay.acc.message.BaseHttpSSLSocketFactory.TrustAnyHostnameVerifier;
...
public class HttpClient {
	 ...
	 * @throws IOException
	 */
	private InputStream responseZip(final HttpURLConnection connection, String encoding)
			throws URISyntaxException, IOException, Exception {
		InputStream in = null;
		try {
			in = connection.getInputStream();
