...
//@Transactional
//public class AccountSplitHandlerServiceTest  extends AbstractTransactionalTestNGSpringContextTests{
//	@Resource(name = "acc-accountBalanceHandlerService")
//	private AccountBalanceHandlerService accountBalanceHandlerService;
//	
//	@Resource(name = "acc-accountSplitHandlerService")
//	private AccountSplitHandlerService splitHandlerService;
//
...
//	
//	//@Test
//	public void test_batchUpdateAcctBalanceRntx(){
//		try {    
//			List<CalFeeReponseDto> updateBalanceRequestList = new ArrayList<CalFeeReponseDto>();
//			List<FreezeBalanceDto> freezeList = new ArrayList<FreezeBalanceDto>(); 
//			for(int i = 0;i<1;i++){
//				CalFeeReponseDto reDto  = this.initCalFeeReponseDto();
//				updateBalanceRequestList.add(reDto);
//			}
//			for(int i = 0;i<1;i++){
//				FreezeBalanceDto fbDto = new FreezeBalanceDto();
//				fbDto.setAcctCode("20010200100011000000037810");
//				fbDto.setAcctType(10);
//				fbDto.setMemberCode(20000000047L);
//				fbDto.setAmount(BigDecimal.valueOf(2000));
//				freezeList.add(fbDto);
//			}
//			
//		    boolean  result =	splitHandlerService.batchUpdateAcctBalanceRntx(updateBalanceRequestList, freezeList, 2);
//		   
...
//	}
//	@Test
//	public void test_batchSplitAcctBalanceRntx(){
//		List<CalFeeReponseDto> updateBalanceRequestList = new ArrayList<CalFeeReponseDto>();
//		List<FreezeBalanceDto> freezeList = new ArrayList<FreezeBalanceDto>(); 
//		for(int i = 0;i<1;i++){
//			CalFeeReponseDto reDto  = this.initCalFeeReponseDto();
//			updateBalanceRequestList.add(reDto);
//		}
//		FreezeBalanceDto unfreezeDto = new FreezeBalanceDto();
//		unfreezeDto.setAcctCode("20010200100011000000037810");
//		unfreezeDto.setAmount(BigDecimal.valueOf(3000));
//		unfreezeDto.setAcctType(10);
//		unfreezeDto.setMemberCode(10000000378L);//10000000378
//		//unfreezeDto.setTransOrderSeq(transOrderSeq);
//		for(int i = 0;i<1;i++){
//			FreezeBalanceDto fbDto = new FreezeBalanceDto();
//			fbDto.setAcctCode("20010200100011000000037710");//
//			fbDto.setAcctType(10);
//			fbDto.setMemberCode(10000000377L);
//			fbDto.setAmount(BigDecimal.valueOf(1000));
//			freezeList.add(fbDto);
//		}
//		
//		
//		try {
//			boolean result = splitHandlerService.batchSplitAcctBalanceRntx(updateBalanceRequestList, unfreezeDto,freezeList,2);
//			System.out.println("result--------------------->"+result);
//		} catch (MaAcctBalanceException e) {
//			e.printStackTrace();
//		}
...
//	
//	//@Test
//	public void test_batchRefundBalanceRntx(){
//		List<CalFeeReponseDto> updateBalanceRequestList = new ArrayList<CalFeeReponseDto>();
//		List<FreezeBalanceDto> freezeList = new ArrayList<FreezeBalanceDto>(); 
//		for(int i = 0;i<1;i++){
//			CalFeeReponseDto reDto  = this.initCalFeeReponseDto();
...
//		}
//		try {
//			boolean result = splitHandlerService.batchRefundBalanceRntx(freezeList,updateBalanceRequestList,2);
//			System.out.println("result--------------------->"+result);
//		} catch (MaAcctBalanceException e) {
//			e.printStackTrace();
//		}
...
//		String seialNo ="201206070000"+RandomUtil.randomDegital(7);
...
//		payCalFeeDetailDto1.setMaBlanceBy(2);//reduce
...
//		revCalFeeDetailDto1.setMaBlanceBy(1);//add
...
//		calFeeReponseDto.setCalFeeRequestDto(calFeeRequestDto);
//		calFeeReponseDto.setVoucherCode(Long.valueOf(RandomUtil.randomDegital(13)));
//		return calFeeReponseDto;
//	}
////	private CalFeeReponseDto initCalFeeReponseDto(){
////		CalFeeReponseDto calFeeReponseDto = new CalFeeReponseDto();
