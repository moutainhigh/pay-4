...
//		calFeeReqDto.setPayerOrgType(String.valueOf(ORGTYPE.MEMBER.getValue()));
//
...
//		calFeeReqDto.setPayeeOrgType(String.valueOf(ORGTYPE.BANK.getValue())); // 会员账户无需orgType
