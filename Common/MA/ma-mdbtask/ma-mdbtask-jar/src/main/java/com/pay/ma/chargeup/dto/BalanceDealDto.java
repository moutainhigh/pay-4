 ...
 * 
 */
package com.pay.ma.chargeup.dto;
 ...
 * 
 */
public class BalanceDealDto implements Serializable {
	...
	public String toString() {
		return "BalanceDeal [amount=" + amount + ", chargeUpStatus=" + chargeUpStatus + ", dealCode=" + dealCode + ", dealType=" + dealType
				+ ", exchangeRate=" + exchangeRate + ", hasCaculatedPrice=" + hasCaculatedPrice + ", id=" + id + ", orderAmount="
				+ orderAmount + ", orderCode=" + orderCode + ", orderId=" + orderId + ", payMethod=" + payMethod + ", payee=" + payee
				+ ", payeeAcctType=" + payeeAcctType + ", payeeCurrencyCode=" + payeeCurrencyCode + ", payeeFee=" + payeeFee
				+ ", payeeFullMemberAcctCode=" + payeeFullMemberAcctCode + ", payeeMemberAcctCode=" + payeeMemberAcctCode
				+ ", payeeOrgCode=" + payeeOrgCode + ", payeeOrgType=" + payeeOrgType + ", payeeServiceLevel=" + payeeServiceLevel
				+ ", payer=" + payer + ", payerAcctType=" + payerAcctType + ", payerCurrencyCode=" + payerCurrencyCode + ", payerFee="
				+ payerFee + ", payerFullMemberAcctCode=" + payerFullMemberAcctCode + ", payerMemberAcctCode=" + payerMemberAcctCode
				+ ", payerOrgCode=" + payerOrgCode + ", payerOrgType=" + payerOrgType + ", payerServiceLevel=" + payerServiceLevel
				+ ", paymentServicePkgCode=" + paymentServicePkgCode + ", requestDate=" + requestDate + ", submitAcctCode="
				+ submitAcctCode + ", terminalType=" + terminalType + "]";
	}
