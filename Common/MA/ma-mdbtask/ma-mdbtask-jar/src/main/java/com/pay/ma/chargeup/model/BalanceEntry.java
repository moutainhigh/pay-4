...
public class BalanceEntry implements Serializable {
	...
	public String toString() {
		return "BalanceEntryDto [acctcode=" + acctcode + ", balance=" + balance + ", crdr=" + crdr + ", createDate=" + createDate
				+ ", createdate=" + createdate + ", currencyCode=" + currencyCode + ", dealId=" + dealId + ", entrycode=" + entrycode
				+ ", exchangeRate=" + exchangeRate + ", id=" + id + ", maBlanceBy=" + maBlanceBy + ", payDate=" + payDate
				+ ", paymentServiceId=" + paymentServiceId + ", postDate=" + postDate + ", status=" + status + ", text=" + text
				+ ", transactiondate=" + transactiondate + ", updateDate=" + updateDate + ", value=" + value + ", vouchercode="
				+ vouchercode + "]";
	}
