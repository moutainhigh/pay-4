 ...
 *  @author lIWEI
 *  @Date 2013-4-12
 *  @Description 民生 国付宝 充退
 */
class Gp_G2R_Cmbc extends AbstractBankFileGenerator {
	...
	public boolean supportBank(String bankCode) {
		return "10007005".equals(bankCode);
	}
	...
	protected void buildBankDetailList(FileGenerateResult fileGenerateResult) {
		...
		String fileName = "cmbc_"+dateString + "_" + fileGenerateResult.getBatchNum()+"_gp"+"_"+"dg";
		...
		summaryModel.setBankCode("10007005");
