 ...
 */
class Cnpy_G2R_11001003 extends AbstractBankFileGenerator {
	...
	public boolean supportBank(String bankCode) {
		return "11001003".equals(bankCode);
	}
	...
	protected void buildBankDetailList(FileGenerateResult fileGenerateResult) {
		...
		String fileName = "TH104310048993766_"+dateString + "_" + "03";
		...
		summaryModel.setBankCode("11001003");
		summaryModel.setDate(dateString);
		summaryModel.setBatchNum("03");
