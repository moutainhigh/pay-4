 ...
 */
class Ceb_G2R_10014003 extends AbstractBankFileGenerator{
...
*/
   ...
   public boolean supportBank(String bankCode) {
	   return "10014003".equals(bankCode);
   }
   ...
   public String supportTradeType() {
	...
	protected void buildBankDetailList(FileGenerateResult fileGenerateResult) {
		...
		String fileName = "ceb_"+dateString + "_" + fileGenerateResult.getBatchNum()+"_3";
		...
		summaryModel.setBankCode("10014003");
