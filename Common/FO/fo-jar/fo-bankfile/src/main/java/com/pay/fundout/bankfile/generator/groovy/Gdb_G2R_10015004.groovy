 ...
 *  @Description 广发充退
 */
class Gdb_G2R_10015004 extends AbstractBankFileGenerator {
	...
	public boolean supportBank(String bankCode) {
		return "10015004".equals(bankCode);
	}
	...
	protected void buildBankDetailList(FileGenerateResult fileGenerateResult) {
		...
		String fileName = "boc_"+dateString + "_" + fileGenerateResult.getBatchNum()+"_4";
		...
		summaryModel.setBankCode("10015004");
