...
import com.pay.fundout.bankfile.generator.model.ecitic.EciticGenModel

/**		
 *  @author lIWEI
 *  @Date 2011-9-16
 *  @Description 中信 同行代发(对公)
 */
class Ecitic_G2E extends AbstractBankFileGenerator {
	...
	protected void buildBankDetailList(FileGenerateResult fileGenerateResult) {
		...
		String fileName ="ecitic_"+dateString + "_"+fileGenerateResult.getBatchNum()+"_3";
		...
		fileGenerateResult.setTemplateName("ecitic_gen2e.vm");
