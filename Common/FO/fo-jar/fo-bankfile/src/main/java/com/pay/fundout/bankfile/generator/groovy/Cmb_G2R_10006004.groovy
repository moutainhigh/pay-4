 ...
 */
class Cmb_G2R_10006004 extends AbstractBankFileGenerator {
	...
	public boolean supportBank(String bankCode) {
		return "10006004".equals(bankCode);
	}
	...
	protected void buildBankDetailList(FileGenerateResult fileGenerateResult) {
		...
		String fileName = "cmb_"+dateString + "_" + fileGenerateResult.getBatchNum()+"_4";
		...
		summaryModel.setBankCode("10006004");
