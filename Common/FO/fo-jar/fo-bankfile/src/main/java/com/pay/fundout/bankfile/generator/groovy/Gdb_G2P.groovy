...
import com.pay.fundout.bankfile.generator.model.gdb.GdbGenModel

/**		
 *  @author lIWEI
 *  @Date 2011-7-4
 *  @Description 广发银行 同行代发
 *  @Copyright Copyright © 2004-2013 pay.com . All rights reserved. GCPayment版权所有
 */
class Gdb_G2P extends AbstractBankFileGenerator {
	...
	protected void buildBankDetailList(FileGenerateResult fileGenerateResult) {
		...
		String fileName ="GDBZFBA"+dateString + randomSr+"SR";
		...
		fileGenerateResult.setTemplateName("gdb_gen2p.vm");
