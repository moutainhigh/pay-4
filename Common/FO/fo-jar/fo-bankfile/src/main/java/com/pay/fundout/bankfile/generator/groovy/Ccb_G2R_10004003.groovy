 ...
 */
class Ccb_G2R_10004003 extends AbstractBankFileGenerator {
	...
	public boolean supportBank(String bankCode) {
		return "10004003".equals(bankCode);
	}
	...
	protected void buildBankDetailList(FileGenerateResult fileGenerateResult) {
		...
		String fileName = "ccb_"+dateString + "_" + fileGenerateResult.getBatchNum()+"_3";
		...
		summaryModel.setBankCode("10004003");
