...
import com.pay.fundout.bankfile.generator.model.sdb.SdbGeneratorModel
 ...
 * @see 
 */
class Pingan_G extends AbstractBankFileGenerator {
	...
	protected void buildBankDetailList(FileGenerateResult fileGenerateResult) {
		...
		for(FileDetailMode fileDetailMode : fileGenerateResult.getDetailList()){
			...
			sdbGeneratorModel.setUse(remark);
		...
		String fileName ="pingan_"+dateString + "_" + fileGenerateResult.getBatchNum()+"_"+"ALL";
		...
		fileGenerateResult.setTemplateName("pingan_gen.vm");
