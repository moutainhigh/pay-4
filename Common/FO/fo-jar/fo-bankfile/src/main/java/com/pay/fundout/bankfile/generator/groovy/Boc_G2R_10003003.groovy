 ...
 */
class Boc_G2R_10003003 extends AbstractBankFileGenerator {
	...
	public boolean supportBank(String bankCode) {
		return "10003003".equals(bankCode);
	}
	...
	protected void buildBankDetailList(FileGenerateResult fileGenerateResult) {
		...
		String fileName = "boc_"+dateString + "_" + fileGenerateResult.getBatchNum()+"_3";
		...
		summaryModel.setBankCode("10003003");
