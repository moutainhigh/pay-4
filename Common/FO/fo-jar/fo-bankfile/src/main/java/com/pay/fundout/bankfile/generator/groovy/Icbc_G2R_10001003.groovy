 ...
 *  @author lIWEI
 *  @Date 2011-7-8
 *  @Description 工行大额充退出款文件
 *  @Copyright Copyright © 2004-2013 pay.com . All rights reserved. GCPayment版权所有
 */
class Icbc_G2R_10001003 extends AbstractBankFileGenerator {
	...
	public boolean supportBank(String bankCode) {
		return "10001003".equals(bankCode);
	}
	...
	protected void buildBankDetailList(FileGenerateResult fileGenerateResult) {
		...
		String fileName = "icbc_"+dateString + "_" + fileGenerateResult.getBatchNum()+"_3"+"_"+"dg";
		...
		summaryModel.setBankCode("10001003");
