 ...
 */
class Bcm_G2R_10005003 extends AbstractBankFileGenerator {
	...
	public boolean supportBank(String bankCode) {
		return "10005003".equals(bankCode);
	}
	...
	protected void buildBankDetailList(FileGenerateResult fileGenerateResult) {
		...
		String fileName = "bcm_"+dateString + "_" + fileGenerateResult.getBatchNum()+"_3"+"_"+"dg";
		...
		summaryModel.setBankCode("10005003");
