 ...
 *  @author lIWEI
 *  @Date 2012-6-7
 *  @Description 中行充退出款文 b2b
 *  @Copyright Copyright © 2004-2013 pay.com . All rights reserved. GCPayment版权所有
 */
class Boc_G2R_10003002 extends AbstractBankFileGenerator {
	...
	public boolean supportBank(String bankCode) {
		return "10003002".equals(bankCode);
	}
	...
	protected void buildBankDetailList(FileGenerateResult fileGenerateResult) {
		...
		String fileName = "boc_"+dateString + "_" + fileGenerateResult.getBatchNum()+"_15844";
