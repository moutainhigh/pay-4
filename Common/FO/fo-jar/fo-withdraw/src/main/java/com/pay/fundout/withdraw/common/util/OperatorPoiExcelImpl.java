 ...
 * @see
 */
public class OperatorPoiExcelImpl extends AbstractOperatorPoi implements OperatorPoiInterface {

	public <T> HSSFWorkbook buildExcel(String sheetName,List<T> list) throws Exception{
