...
//		i_ = fileName.lastIndexOf("/");
	...
	public static String writeWorkBookFile(Workbook workbook, Map<String, String> fileInfo) {
		...
		String basePath = fileInfo.get("BATCH_FILE_PATH") + FILE_PATH_SEPARATOR_CH + WITHDRAW_DIR_NAME;
		String fileFormat = fileInfo.get("BATCH_FILENAME_SUBFIX");
		String businessType = fileInfo.get("BATCH_TASK_TYPE");
		String fileType = "1";
		String batchNum = fileInfo.get("BATCH_NUM");
	 ...
	 * @return
	 */
	public static String writeFile(List<WithdrawDetailInfo> list, Map<String, String> fileInfo) {
		...
		try {
			...
			for (WithdrawDetailInfo withdrawDetailInfo : list) {
				StringBuffer sb = new StringBuffer();
				String applyRemark = withdrawDetailInfo.getApplyRemark();
				BigDecimal applyAmount = withdrawDetailInfo.getApplyAmount();
				sb.append("|");
