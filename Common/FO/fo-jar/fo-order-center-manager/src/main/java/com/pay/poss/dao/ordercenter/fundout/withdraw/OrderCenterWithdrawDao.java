package com.pay.poss.dao.ordercenter.fundout.withdraw;
 ...
 * @see
 */
public interface OrderCenterWithdrawDao extends BaseDAO {

	Page<OrderCenterResultDTO> queryWithdrawResultList(
	 ...
	 * @return
	 */
	List<OrderRelationDTO> queryWithdrawRelationList(OrderCenterQueryDTO dto);
}
