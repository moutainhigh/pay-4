package com.pay.poss.service.ordercenter.fundin.impl.recharge4pay;
 ...
 * @see
 */
public class OrderCenterRecharge4PayServiceImpl extends AbstractOrderCenterCommonService{

	private final static Integer ACC_TYPE_RMB = 10;
	private static Log logger = LogFactory.getLog(OrderCenterRecharge4PayServiceImpl.class);
	private OrderCenterRecharge4PayDao orderCenterRecharge4PayDao ;
	private PEService peService;
	public void setPeService(PEService peService) {
		this.peService = peService;
	}	
	public void setOrderCenterRecharge4PayDao(
			OrderCenterRecharge4PayDao orderCenterRecharge4PayDao) {
		this.orderCenterRecharge4PayDao = orderCenterRecharge4PayDao;
	}
	...
	public Map<String, Page<OrderCenterResultDTO>> queryResultList(
		...
		map.put("page", orderCenterRecharge4PayDao.queryRechargeResultList(page, dto));
		return map;
	}
	...
	public OrderDetailDTO queryOrderDetail(OrderCenterQueryDTO queryDto) {
		...
		try {
			...
			orderDetailDTO = orderCenterRecharge4PayDao.queryOrderDetail(primaryKy);
...
//			orderDetailDTO.setRemarks(String);  //留言
	...
	public Map<String, Object> queryOrderRelation(OrderCenterQueryDTO queryDto) {
		...
		map.put("relationList", orderCenterRecharge4PayDao.queryRefundRelationList(queryDto));
		return map;
	}
