package com.pay.poss.service.ordercenter.fundin.impl.reverse;
 ...
 * @see
 */
public class OrderCenterReverseServiceImpl extends AbstractOrderCenterCommonService{

	private final static Integer ACC_TYPE_RMB = 10;
	private static Log logger = LogFactory.getLog(OrderCenterReverseServiceImpl.class);
	private OrderCenterReverseDao orderCenterReverseDao ;
	private PEService peService;
	public void setPeService(PEService peService) {
		this.peService = peService;
	}	
	public void setOrderCenterReverseDao(
			OrderCenterReverseDao orderCenterReverseDao) {
		this.orderCenterReverseDao = orderCenterReverseDao;
	}
	...
	public Map<String, Page<OrderCenterResultDTO>> queryResultList(
		...
		map.put("page", orderCenterReverseDao.queryRechargeResultList(page, dto));
		return map;
	}
	...
	public OrderDetailDTO queryOrderDetail(OrderCenterQueryDTO queryDto) {
		...
		try {
			...
			orderDetailDTO = orderCenterReverseDao.queryOrderDetail(primaryKy);
...
//			orderDetailDTO.setRemarks(String);  //留言
	...
	public Map<String, Object> queryOrderRelation(OrderCenterQueryDTO queryDto) {
		...
		map.put("relationList", orderCenterReverseDao.queryRefundRelationList(queryDto));
		return map;
	}
