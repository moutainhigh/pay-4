/**
 *  File: Batch2bankTargetTypeCheckRule.java
 *  Description:
 ...
 * 收款方对公、对私
 */
public class Batch2bankTargetTypeCheckRule extends MessageRule {
	...
	protected boolean makeDecision(Object validateBean) throws Exception {
		...
		if(!StringUtil.isEmpty(type)){
			type = type.replaceAll("Ｃ", "C");
			type = type.replaceAll("Ｂ", "B");
			detailRequest.setTradeType(type);
		}
		
		if (!BatchPaymentToBankReqDetailDTO.ENTERPRICE.equalsIgnoreCase(type)
				&& !BatchPaymentToBankReqDetailDTO.PESONER
