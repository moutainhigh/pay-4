 ...
 * 
 */
public class BatchPaymentQueryController extends MultiActionController {

	private Log logger = LogFactory.getLog(BatchPaymentQueryController.class);
	...
	public ModelAndView index(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		String resultXml = messageHandleService.process(command.getMerchantCode(), command.getBizNo(), xml);
