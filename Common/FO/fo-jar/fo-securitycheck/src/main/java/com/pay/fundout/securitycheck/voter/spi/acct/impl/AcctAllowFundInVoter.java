/**
 *  File: AcctAllowFundInVoter.java
 *  Description:
 ...
 * 
 */
public class AcctAllowFundInVoter extends BaseAcctAttributeVoter {
	@Override
	protected int doVote(int busiType, Principal principal, DenyVoteMsg denyVoteMsg) {
		...
		try {
			...
			if (acctAttrInfo.getAllowTransferIn().intValue() == 0) {
				denyVoteMsg.setCode(Constants.DENY_CODE_ACCT_FUNDIN);
