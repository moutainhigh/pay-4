 ...
 * @author lIWEI
 * @Date 2011-6-27
 * @Description 此类用来处理来自fi的前台商户退款请求
 * @Copyright Copyright © 2004-2013 pay.com . All rights reserved. 版权所有
 */
public class CustomRefundFromFiResponseJmsQueueListener implements
		MessageListener {
