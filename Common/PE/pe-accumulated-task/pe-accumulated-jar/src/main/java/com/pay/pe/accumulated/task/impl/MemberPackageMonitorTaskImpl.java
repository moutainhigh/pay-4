...
* @ClassName: MemberPackageMonitorTaskImpl
* @Description: 会员包量监控task
* @author  cf
* @date Nov 07, 2013
*
*/ 
public class MemberPackageMonitorTaskImpl extends AbstractTask{


	private Log log = LogFactory.getLog(MemberPackageMonitorTaskImpl.class);
	...
	protected void doTask() {
		...
		log.info("-----------会员包量配置监控定时任务执行结束-----------");
	}

	@Override
	protected String getTaskName() {
		return "MemberPackageMonitorTaskImpl";
	}
