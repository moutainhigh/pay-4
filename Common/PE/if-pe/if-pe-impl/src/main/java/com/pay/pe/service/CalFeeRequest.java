...
public class CalFeeRequest implements Serializable {
	...
	private int terminalType = TerminalType.WEB.getValue();
	...
	private Integer payerServiceLevel = null;
	...
	public String toString() {
		...
		buffer.append("orderCode=" + orderCode + "\n");
		buffer.append("dealCode=" + dealCode + "\n");
		buffer.append("payMethod=" + payMethod + "\n");
		buffer.append("requestDate=" + requestDate + "\n");
		buffer.append("amount=" + amount + "\n");
		buffer.append("payer=" + payer + "\n");
		buffer.append("payerMemberAcctCode=" + payerMemberAcctCode + "\n");
		buffer.append("payerAcctType=" + payerAcctType + "\n");
		buffer.append("payerFullMemberAcctCode=" + payerFullMemberAcctCode
				+ "\n");
		buffer.append("payerOrgType=" + payerOrgType + "\n");
		buffer.append("payerOrgCode=" + payerOrgCode + "\n");
		buffer.append("payerServiceLevel=" + payerServiceLevel + "\n");

		buffer.append("payee=" + payee + "\n");
		buffer.append("payeeMemberAcctCode=" + payeeMemberAcctCode + "\n");
		buffer.append("payeeAcctType=" + payeeAcctType + "\n");
		buffer.append("payeeFullMemberAcctCode=" + payeeFullMemberAcctCode
				+ "\n");
		buffer.append("payeeOrgType=" + payeeOrgType + "\n");
		buffer.append("payeeOrgCode=" + payeeOrgCode + "\n");
		buffer.append("payeeServiceLevel=" + payeeServiceLevel + "\n");
