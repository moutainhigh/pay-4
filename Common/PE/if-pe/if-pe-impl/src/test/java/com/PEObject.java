...
public class PEObject {
	...
	/**
	 * 1代表个人 付款方机构类型代码，MEMBER(1), BANK(3),
	...
	public PEObject(String memberCode, String orderId, Integer accountType,
			Integer payerOrgType, String payerOrgCode, Integer dealCode,
			Integer orderCode, Integer payMethod) {
