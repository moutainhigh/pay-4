...
@Transactional
public class Card2CalFeeServiceTest extends
...
//	}
	...
	public void testCalculateFeeDetai801() throws Exception {
		...
		PaymentResponseDto calFeeRespone = peService.processPayment(paymentReqDto);
...
//		peService.accountingCalFeeReponse(calFeeRespone);
	...
	@Test
	public void testCalculateFeeDetai804() throws Exception {
		CalFeeRequest calFeeReqDto = initCalFeeRequest(804,3,1);
//		CalFeeReponse calFeeRespone = peService.processPayment(calFeeReqDto);
//		peService.accountingCalFeeReponse(calFeeRespone);
	}
	
	@Test
	public void testCalculateFeeDetai806() throws Exception {
		CalFeeRequest calFeeReqDto = initCalFeeRequest(806,1,3);
//		CalFeeReponse calFeeRespone = peService.processPayment(calFeeReqDto);
//		peService.accountingCalFeeReponse(calFeeRespone);
	}
