...
public class PartnerWebsiteConfigCriteria {
    ...
    public PartnerWebsiteConfigCriteria() {
        oredCriteria = new ArrayList<Criteria>();
    }

    protected PartnerWebsiteConfigCriteria(PartnerWebsiteConfigCriteria example) {
