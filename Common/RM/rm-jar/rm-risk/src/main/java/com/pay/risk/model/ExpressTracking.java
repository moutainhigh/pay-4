...
public class ExpressTracking {
	...
	private String uploadeDateStart;
	
	private String uploadeDateEnd;
	
	public String getUploadeDateStart() {
		return uploadeDateStart;
	}

	public void setUploadeDateStart(String uploadeDateStart) {
		this.uploadeDateStart = uploadeDateStart;
	}

	public String getUploadeDateEnd() {
		return uploadeDateEnd;
	}

	public void setUploadeDateEnd(String uploadeDateEnd) {
		this.uploadeDateEnd = uploadeDateEnd;
	}
