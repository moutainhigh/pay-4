package com.pay.rm.base.exception.enums;
/**
 * @Description 异常代码枚举
 * @project 	rm-base
...
public enum ExceptionCodeEnum {
	...
	MEMBER_ACCT_TEMPLATE_NOT_EXISTS("0011","默认账户模版读取错误"),
	...
	MCC_NOT_EXIST("1001","MCC不存在"),
	UPDATE_BUSINESSLIMITCUSTOM_EXCEPTION("1002","更新商户定制限额异常"),
	NAMELIST_EXCEPTION("1003","黑白名单异常");
