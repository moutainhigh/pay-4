package com.pay.rm.service.dto.rmlimit.innerlimit;
 ...
 * RC_LIMIT 直营限额
 */
public class RcInnerLimitDTO extends BaseObject {

	private static final long serialVersionUID = -1323065525123427340L;
