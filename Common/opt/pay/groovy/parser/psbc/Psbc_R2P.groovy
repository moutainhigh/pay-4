 ...
 *  @author lIWEI
 *  @Date 2011-8-12
 *  @Description 邮储同行代发结果文件
 *  @Copyright Copyright © 2004-2013 hnapay.com . All rights reserved. 海航新生版权所有
 */
class Psbc_R2P extends AbstractBaseFileParser {

	/* 
批量转账查询结果									
收款人账号	  			 		金额		手续费	汇划费	用途		附言			交易时间		处理结果		失败原因
6221882900054472121		桂世勇 	0.01	0		0		货款		123456789,	2011-07-05	交易成功	
6221882900002320695		张俊义 	0.01	0		0		货款					2011-07-05	交易成功	
	 */
	@Override
