 ...
 */
class Psbc_G2R_10010003 extends AbstractBankFileGenerator {
	...
	public boolean supportBank(String bankCode) {
		return "10010003".equals(bankCode);
	}
	...
	protected void buildBankDetailList(FileGenerateResult fileGenerateResult) {
		...
		String fileName = "psbc_"+dateString + "_" + fileGenerateResult.getBatchNum()+"_3"+"_"+"r";
		...
		summaryModel.setBankCode("10010003");
