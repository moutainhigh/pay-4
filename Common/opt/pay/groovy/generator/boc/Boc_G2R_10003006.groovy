 ...
 *  @author lIWEI
 *  @Date 2011-8-10
 *  @Description 中行B2C综合充退出款文
 *  @Copyright Copyright © 2004-2013 pay.com . All rights reserved. 海航新生版权所有
 */
class Boc_G2R_10003006 extends AbstractBankFileGenerator {
	...
	public boolean supportBank(String bankCode) {
		return "10003006".equals(bankCode);
	}
