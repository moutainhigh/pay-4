 ...
 *  @author lIWEI
 *  @Date 2011-8-23
 *  @Description 中国银行 代发代扣（上海地区）
 */
class Boc_G2P extends AbstractBankFileGenerator {
	...
	protected void buildBankDetailList(FileGenerateResult fileGenerateResult) {
		...
		String fileName ="boc_${dateString}_${fileGenerateResult.getBatchNum()}_5";
