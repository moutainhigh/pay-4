 ...
 *  @author lIWEI
 *  @Date 2012-6-7
 *  @Description 建行充退出款文件 b2b
 *  @Copyright Copyright © 2004-2013 hnapay.com . All rights reserved. 海航新生版权所有
 */
class Ccb_G2R_10004002 extends AbstractBankFileGenerator {
	...
	public boolean supportBank(String bankCode) {
		return "10004002".equals(bankCode);
	}
	...
	protected void buildBankDetailList(FileGenerateResult fileGenerateResult) {
		...
		String fileName = "ccb_"+dateString + "_" + fileGenerateResult.getBatchNum()+"_2";
		...
		summaryModel.setBankCode("10004002");
