 ...
 *  @author lIWEI
 *  @Date 2012-5-18
 *  @Description 工行大额充退出款文件 b2b
 *  @Copyright Copyright © 2004-2013 hnapay.com . All rights reserved. 海航新生版权所有
 */
class Icbc_G2R_10001002 extends AbstractBankFileGenerator {
	...
	public boolean supportBank(String bankCode) {
		return "10001006".equals(bankCode);
	}
	...
	protected void buildBankDetailList(FileGenerateResult fileGenerateResult) {
		...
		String fileName = "icbc_"+dateString + "_" + fileGenerateResult.getBatchNum()+"_2"+"_"+"dg";
		...
		summaryModel.setBankCode("10001006");
