 ...
 * @see 
 */
class Icbc_G2E extends AbstractBankFileGenerator {
	...
	public void buildBankDetailList(FileGenerateResult fileGenerateResult){
		...
		String fileName = "icbc_"+ dateString + "_" +Integer.toHexString(fileGenerateResult.getBatchNum().hashCode()) +"_"+"dg";
		...
		fileGenerateResult.setTemplateName("icbc_gen2e.vm");
