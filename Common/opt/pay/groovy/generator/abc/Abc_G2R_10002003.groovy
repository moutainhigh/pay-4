 ...
 *  @author lIWEI
 *  @Date 2011-7-8
 *  @Description 农行大额充退出款文件
 *  @Copyright Copyright © 2004-2013 hnapay.com . All rights reserved. 海航新生版权所有
 */
class Abc_G2R_10002003 extends AbstractBankFileGenerator {
	...
	public boolean supportBank(String bankCode) {
		return "10002003".equals(bankCode);
	}
	...
	protected void buildBankDetailList(FileGenerateResult fileGenerateResult) {
		...
		String fileName = "abc_"+dateString + "_" + fileGenerateResult.getBatchNum()+"_3"+"_"+"dg";
		...
		summaryModel.setBankCode("10002003");
