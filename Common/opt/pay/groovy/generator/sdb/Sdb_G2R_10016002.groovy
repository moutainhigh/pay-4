 ...
 * 深发展充退生成文件
 */
class Sdb_G2R_10016002 extends AbstractBankFileGenerator {
	...
	public boolean supportBank(String bankCode) {
		return "10016002".equals(bankCode);
	}
	...
	protected void buildBankDetailList(FileGenerateResult fileGenerateResult) {
		...
		String fileName = "sdb_"+ dateString + "_" + fileGenerateResult.getBatchNum()+"_"+"R2";
		...
		summaryModel.setBankCode("10016002");
	...
	/*protected void buildBankDetailList(FileGenerateResult fileGenerateResult) {
		...
		String fileName = "sdb_"+dateString + "_" + batchNum+"_R2";
		fileGenerateResult.setFileName(fileName);
