 ...
 *  @author lIWEI
 *  @Date 2013-4-12
 *  @Description 建行 国付宝 充退
 */
class Gp_G2R_Ccb extends AbstractBankFileGenerator {
	...
	public boolean supportBank(String bankCode) {
		return "10004005".equals(bankCode);
	}
	...
	protected void buildBankDetailList(FileGenerateResult fileGenerateResult) {
		...
		String fileName = "ccb_"+dateString + "_" + fileGenerateResult.getBatchNum()+"_gp"+"_"+"dg";
		...
		summaryModel.setBankCode("10004005");
